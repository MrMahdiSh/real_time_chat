!function (t, e) {
    ...
    var i = 1, n = {}, o = {
        _setEntry: function (t, e) {
            var o = t.__pubSubUID;
            return o || (o = i++, t.__pubSubUID = o, n[o] = {obj: t}), n[o][e] || (n[o][e] = []), n[o]
        }, _getEntryProp: function (t, e) {
            return n[t.__pubSubUID] ? n[t.__pubSubUID][e] : null
            ...
            for (var n, o = this._setEntry(t, "subscriptions"), r = 0, s = o.subscriptions, a = s.length; r < a; r++) if (n = s[r], n.type === e && n.fn === i) return;
            s.push({type: e, fn: i})
        }, unsubscribe: function (t, e, i) {
            var n = this._getEntryProp(t, "subscriptions");
            if (n) {
                for (var o, r = n.length; --r >= 0;) o = n[r], o.type !== e || o.fn !== i && i || n.splice(r, 1);
            ...
            for (var n, o = this._setEntry(t, "subscriptions"), r = [], s = 0, a = o.subscriptions, h = a.length, u = o.receivers; s < h; s++) n = a[s], n.type === e && r.push(n);
            for (h = r.length, s = 0; s < h; s++) r[s].fn(i);
            if (u && (u.length || a.length) || this._clearEntry(t), u) for (h = u.length, s = 0; s < h; s++) this.publish(u[s], e, i)
        }, inform: function (t, e) {
            return !(!t || !e) && (this._setEntry(t, "receivers").receivers.push(e), !0)
        }, conceal: function (t, e) {
            if (!t || !e) return !1;
            var i = this._getEntryProp(t, "receivers");
            if (!i) return !1;
            for (var n = i.length, o = !1; --n >= 0;) i[n] === e && (i.splice(n, 1), o = !0);
            return i.length || this._clearEntry(t), o
        }
    };
    ...
    i.prototype = {
        then: function (t, e) {
            this._thens.push({resolve: t, reject: e})
        }, resolve: function (t) {
            ...
            for (var i, n = 0; i = this._thens[n++];) i[t] && i[t](e);
            delete this._thens
        }
    ...
    "use strict";
    var i, n = t.document ? t.document.body : null;
    ...
    "use strict";
    var i = null, n = null, o = t.document ? t.document.body : null;
    !o || o.matches ? n = "matches" : (o.webkitMatchesSelector ? n = "webkit" : o.mozMatchesSelector ? n = "moz" : o.msMatchesSelector ? n = "ms" : o.oMatchesSelector && (n = "o"), n += "MatchesSelector"), i = n ? function (t, e) {
        ...
        for (var n = (e.parentNode || t.document).querySelectorAll(i) || [], o = n.length; o--;) if (n[o] == e) return !0;
        return !1
    ...
    var i = function (e, i, n, o, r, s) {
        ...
        d.prototype = {
            _parse: function (t, e) {
                ...
                for (var i, n, o, r = 0, s = t.split(","), a = s.length, h = []; a > r; r++) i = s[r].split(":"), n = 0 === i[0].indexOf("was "), o = n ? i[0].substr(4) : i[0], h.push({
                    retain: n,
                    test: o,
                    value: e ? o : void 0 === i[1] || i[1]
                });
                return this._expressions[t] = h, h
            }, _mergeData: function (t, e, i) {
                return s({element: i, expected: e}, t)
            }, create: function (t, e) {
                var i = new n, o = t.getPath(), r = t.getExpected(), s = this;
                return a.loader.require([a.paths.monitors + o], function (n) {
                    var a, h, u, l, c, d, p, f, _ = 0, m = s._db[o], g = n.unload ? s._uid++ : o;
                    if (!m) {
                        if (m = {
                            watches: [], change: function (t) {
                                for (_ = 0, a = m.watches.length; a > _; _++) m.watches[_].test(t)
                            }
                        }, p = n.unload ? s._mergeData(n.data, r, e) : n.data, "function" == typeof n.unload && (m.unload = function (t) {
                            return function () {
                                n.unload(t)
                            }
                        }(p)), "function" == typeof n.trigger) n.trigger(m.change, p); else for (c in n.trigger) n.trigger.hasOwnProperty(c) && n.trigger[c].addEventListener(c, m.change, !1);
                        s._db[g] = m
                    }
                    for (t.assignMonitor(g), u = [], f = "function" == typeof n.test, l = n.parse ? n.parse(r, f) : s._parse(r, f), a = l.length; a > _; _++) d = l[_], h = {
                        changed: null,
                        retain: d.retain,
                        retained: null,
                        valid: null,
                ...
                var e = t.getMonitor();
                if (null !== e) {
                    var i, n = this._db[e], o = n.watches, r = o.length;
                    t.getWatches().forEach(function (t) {
                        for (i = 0; r > i; i++) o[i] === t && o.splice(i, 1)
        ...
        p.prototype = {
            _load: function () {
                ...
                h.create(t, this._element).then(function (o) {
                    for (t.assignWatches(o), e = o.length; e > n; n++) o[n].changed = i._conditionChangeBind;
                    i._condition.evaluate()
                })
            }, destroy: function () {
                for (var t = 0, e = this._tests.length; e > t; t++) h.destroy(this._tests[t]);
                this._conditionChangeBind = null
            }
        };
        var f = {
            _uid: 0, _db: [], clearTest: function (t) {
                var e = this._db[t];
            ...
            this._expression = t, this._negate = void 0 !== e && e
        };
        _.prototype = {
            isTrue: function () {
        ...
        var g = function (t, e) {
            return {
                parse: function (i) {
                    var n, o, r, s, a, h, u, c, d, p, f, _ = 0, m = "", g = [], v = "", y = !1, w = !1, b = null,
                        x = null, S = [], k = i.length;
                    for (b || (b = g); k > _; _++) if (123 !== (h = i.charCodeAt(_))) if (125 === h && (n = b.length - 1, o = n + 1, y = "not" === b[n], o = y ? n : n + 1, s = new l(m, v), b[o] = new t(s, y), m = "", v = "", y = !1, w = !1), w) v += i.charAt(_); else {
                        if (40 === h && (b.push([]), S.push(b), b = b[b.length - 1]), 32 === h || 0 === _ || 40 === h) {
                            if (!(r = i.substr(_, 5).match(/and |or |not /g))) continue;
                            d = r[0], p = d.length - 1, b.push(d.substring(0, p)), _ += p
                        }
                        if (41 === h || _ === k - 1) do {
                            if (x = S.pop(), 0 !== b.length) {
                                for (a = 0, f = b.length; f > a; a++) "string" == typeof b[a] && ("not" === b[a] ? (b.splice(a, 2, new t(b[a + 1], !0)), a = -1, f = b.length) : "not" !== b[a + 1] && (b.splice(a - 1, 3, new e(b[a - 1], b[a], b[a + 1])), a = -1, f = b.length));
                                1 === b.length && x && (x[x.length - 1] = b[0], b = x)
                            } else b = x
                        } while (_ === k - 1 && x)
                    } else for (w = !0, m = "", u = _ - 2; u >= 0 && 32 !== (c = i.charCodeAt(u)) && 40 !== c;) m = i.charAt(u) + m, u--;
        ...
        var w = {
            _options: {}, _redirects: {}, _enabled: {}, registerModule: function (t, e, i, n) {
            ...
            hasInitialized: function () {
                ...
                if ("string" == typeof e) {
                    if (123 != e.charCodeAt(0)) {
                        for (var i = 0, n = e.split(", "), o = n.length; o > i; i++) this._overrideObjectWithUri(t, n[i]);
                        return t
                    }
                    e = JSON.parse(e)
                }
                ...
                for (var i, n = t, o = "", r = 0, s = e.length; s > r;) {
                    if (46 != (i = e.charCodeAt(r)) && 58 != i) o += e.charAt(r); else {
                        if (58 == i) {
                ...
                var n, o, r = [], a = {}, h = {};
                do {
                    n = w.getModule(t), r.push({page: n, module: e.options}), t = e.__superUrl
                } while (e = e.__super);
                for (o = r.length; o--;) a = s(a, r[o].page), h = s(h, r[o].module);
                ...
                return e = e || [], {status: 200, response: i.apply(this._module, e)}
            }
        };
        var x = function () {
            var t = function (t) {
            ...
            return s.hasProcessed = function (t) {
                ...
                load: function (t) {
                    if (t && t.length) {
                        ...
                        for (var e, n = 0, o = this._moduleControllers.length; o > n; n++) e = this._moduleControllers[n], i.subscribe(e, "available", this._moduleAvailableBind), i.subscribe(e, "load", this._moduleLoadBind)
                    }
                }, destroy: function () {
                    ...
                    if (void 0 === t) return e ? this._moduleControllers[0] : this._moduleControllers.concat();
                    for (var i, n = 0, o = this._moduleControllers.length, r = []; o > n; n++) if (i = this._moduleControllers[n], i.wrapsModuleWithPath(t)) {
                        if (e) return i;
                        r.push(i)
                    }
                    return e ? null : r
                    ...
                    return this._moduleControllers.map(function (i) {
                        return {controller: i, result: i.execute(t, e)}
                    })
            ...
            for (var e, n = 0, o = this._controllers.length; o > n; n++) e = this._controllers[n], i.subscribe(e, "load", this._controllerLoadedBind), i.subscribe(e, "unload", this._controllerUnloadedBind);
            this._test()
        };
        S.prototype = {
            destroy: function () {
                for (var t, e = 0, n = this._controllers.length; n > e; e++) (t = this._controllers[e]) && (i.unsubscribe(t, "load", this._controllerLoadedBind), i.unsubscribe(t, "unload", this._controllerUnloadedBind));
                this._controllerLoadedBind = null, this._controllerUnloadedBind = null, this._controllers = null
            }, areAllModulesActive: function () {
                for (var t, e = 0, i = this._controllers.length; i > e; e++) if (t = this._controllers[e], !this._isActiveController(t)) return !1;
                return !0
            }, _onLoad: function () {
                this._test()
            }, _onUnload: function () {
        ...
        var k = new RegExp("^\\[\\s*{"), A = function () {
            this._nodes = []
        };
        return A.prototype = {
            parse: function (t) {
                var e, i, n = t.querySelectorAll("[data-module]"), o = n.length, r = 0, s = [];
                if (!n) return [];
                for (; o > r; r++) i = n[r], x.hasProcessed(i) || s.push(new x(i, i.getAttribute(a.attr.priority)));
                for (s.sort(function (t, e) {
                    return t.getPriority() - e.getPriority()
                }), r = s.length; --r >= 0;) e = s[r], e.load.call(e, this._getModuleControllersByElement(e.getElement()));
                return this._nodes = this._nodes.concat(s), s
            }, load: function (t, e) {
                e = e.length ? e : [e];
                var i, n, o = 0, r = e.length, s = [];
                for (n = new x(t); r > o; o++) i = e[o], s.push(this._getModuleController(i.path, t, i.options, i.conditions));
                return n.load(s), this._nodes.push(n), n
            }, getNodeByElement: function (t) {
                for (var e, i = 0, n = this._nodes.length; n > i; i++) if (e = this._nodes[i], e.getElement() === t) return e;
                return null
            }, getNodes: function (t, e, i) {
                if (void 0 === t && void 0 === e) return i ? this._nodes[0] : this._nodes.concat();
                for (var n, o = 0, r = this._nodes.length, s = []; r > o; o++) if (n = this._nodes[o], n.matchesSelector(t, e)) {
                    if (i) return n;
                    s.push(n)
                }
                return i ? null : s
            }, destroy: function (t) {
                for (var e, i = t.length, n = 0; i--;) -1 !== (e = this._nodes.indexOf(t[i])) && (this._nodes.splice(e, 1), t[i].destroy(), n++);
                return t.length === n
                ...
                if (91 == e.charCodeAt(0)) {
                    ...
                    if (!n) return [];
                    if (i = n.length, k.test(e)) {
                        for (; i > s; s++) o = n[s], w.isModuleEnabled(o.path) && (r[s] = this._getModuleController(o.path, t, o.options, o.conditions));
                        return r
                    }
                    for (; i > s; s++) o = n[s], w.isModuleEnabled("string" == typeof o ? o : o[0]) && (r[s] = "string" == typeof o ? this._getModuleController(o, t) : this._getModuleController(o[0], t, "string" == typeof o[1] ? o[2] : o[1], "string" == typeof o[1] ? o[1] : o[2]));
                    return r
                }
            ...
            loader: {
                require: function (t, i) {
                    ...
                    var i = {};
                    i[t] = e, requirejs.config({config: i})
                }, toUrl: function (t) {
            ...
            init: function (e) {
                ...
                var e, i, n, o, r;
                a = s(a, t);
                for (i in a.paths) a.paths.hasOwnProperty(i) && (a.paths[i] += "/" !== a.paths[i].slice(-1) ? "/" : "");
                for (i in a.modules) a.modules.hasOwnProperty(i) && (n = a.modules[i], o = "string" == typeof n ? n : n.alias, e = "string" == typeof n ? null : n.options || {}, r = "string" == typeof n ? null : n.enabled, w.registerModule(i, e, o, r))
            }, parse: function (t) {
                return u.parse(t)
            }, load: function (t, e) {
                return u.load(t, e)
                ...
                return S.apply(t, [arguments[0].slice ? arguments[0] : Array.prototype.slice.call(arguments, 0)]), t
            }, getNode: function () {
                ...
                var t, e, i, n, o, r, s, a;
                if ("object" == typeof arguments[0]) return s = u.getNodeByElement(arguments[0]), s ? s.getModule(arguments[1]) : null;
                for (e = arguments[0], "string" == typeof arguments[1] ? (i = arguments[1], n = arguments[2]) : n = arguments[1], t = 0, o = u.getNodes(i, n, !1), r = o.length; r > t; t++) if (a = o[t].getModule(e)) return a;
                return null
            }, getModules: function () {
                var t, e, i, n, o, r, s, a, h;
                if ("object" == typeof arguments[0]) return s = u.getNodeByElement(arguments[0]), s.getModules(arguments[1]);
                for (e = arguments[0], "string" == typeof arguments[1] ? (i = arguments[1], n = arguments[2]) : n = arguments[1], t = 0, o = this.getNodes(i, n), r = o.length, h = []; r > t; t++) a = o[t].getModules(e), a.length && (h = h.concat(a));
                return h
            }, is: function (t, e) {
                ...
                var i = new n, o = f.setTest(t, e, function (t) {
...
}(this), require.config({map: {"*": {slim: "slim.amd"}}}), require(["conditioner"], function (t) {
    t.init()
}), define("main", function () {
}), function (t, e) {
    "use strict";
    var i = function (e) {
        var i = t.innerHeight, n = e.getBoundingClientRect();
        return n.top > 0 && n.top < i || n.bottom > 0 && n.bottom < i
    }, n = function (t) {
        return parseInt(t, 10)
    }, o = {
        trigger: {resize: t, scroll: t}, test: {
            visible: function (t) {
    ...
    "use strict";
    var i = {
        data: {mql: null}, trigger: function (e, i) {
            "supported" !== i.expected && (i.change = function () {
                e()
            }, i.mql = t.matchMedia(i.expected), i.mql.addListener(i.change))
        }, parse: function (t) {
            var e = [];
            return "supported" === t ? e.push({test: "supported", value: !0}) : e.push({test: "query", value: t}), e
        }, test: {
            supported: function () {
    ...
    function e(t, e, i, n) {
        if (!(e >= 1)) {
            for (var o = t.width, r = t.height, s = Math.max(n.width, Math.min(i.width, Math.round(t.width * e))), a = Math.max(n.height, Math.min(i.height, Math.round(t.height * e))), h = t, u = null; o > s && r > a;) {
                var l = document.createElement("canvas");
                o = Math.round(.5 * h.width), r = Math.round(.5 * h.height), o < s && (o = s), r < a && (r = a), l.width = o, l.height = r, u = l.getContext("2d"), u.drawImage(h, 0, 0, o, r), g(h), h = l, l = null
            }
            t.width = s, t.height = a, u = t.getContext("2d"), u.drawImage(h, 0, 0, s, a), h !== t && g(h)
        }
    }
    ...
    var i = function (t, e, n) {
            var o, r, s = document.createElement("img");
            if (s.onerror = e, s.onload = function () {
                !r || n && n.noRevoke || i.revokeObjectURL(r), e && e(i.scale(s, n))
            }, i.isInstanceOf("Blob", t) || i.isInstanceOf("File", t)) o = r = i.createObjectURL(t), s._type = t.type; else {
    ...
    i.isInstanceOf = function (t, e) {
        ...
        e = e || {};
        var r, s, a, h, u, l, c, d, p, f, _, m = document.createElement("canvas"),
            g = t.getContext || i.hasCanvasOption(e) && m.getContext, v = t.naturalWidth || t.width,
            y = t.naturalHeight || t.height, w = v, b = y;
        if (g && (e = i.getTransformedOptions(t, e), c = e.left || 0, d = e.top || 0, e.sourceWidth ? (u = e.sourceWidth, void 0 !== e.right && void 0 === e.left && (c = v - u - e.right)) : u = v - c - (e.right || 0), e.sourceHeight ? (l = e.sourceHeight, void 0 !== e.bottom && void 0 === e.top && (d = y - l - e.bottom)) : l = y - d - (e.bottom || 0), w = u, b = l), r = e.maxWidth, s = e.maxHeight, a = e.minWidth, h = e.minHeight, g && r && s && e.crop ? (w = r, b = s, _ = u / l - r / s, _ < 0 ? (l = s * u / r, void 0 === e.top && void 0 === e.bottom && (d = (y - l) / 2)) : _ > 0 && (u = r * l / s, void 0 === e.left && void 0 === e.right && (c = (v - u) / 2))) : ((e.contain || e.cover) && (a = r = r || a, h = s = s || h), e.cover ? (o(), n()) : (n(), o())), g) {
            if (p = e.pixelRatio, p > 1 && (m.style.width = w + "px", m.style.height = b + "px", w *= p, b *= p, m.getContext("2d").scale(p, p)), (f = e.downsamplingRatio) > 0 && f < 1 && w < u && b < l) for (; u * f > w;) m.width = u * f, m.height = l * f, i.renderImageToCanvas(m, t, c, d, u, l, 0, 0, m.width, m.height), u = m.width, l = m.height, t = document.createElement("canvas"), t.width = u, t.height = l, i.renderImageToCanvas(t, m, 0, 0, u, l, 0, 0, u, l);
    ...
    var o = i.hasCanvasOption, r = i.transformCoordinates, s = i.getTransformedOptions;
    i.hasCanvasOption = function (t) {
        return !!t.orientation || o.call(i, t)
    }, i.transformCoordinates = function (t, e) {
        r.call(i, t, e);
        var n = t.getContext("2d"), o = t.width, s = t.height, a = t.style.width, h = t.style.height, u = e.orientation;
        if (u && !(u > 8)) switch (u > 4 && (t.width = s, t.height = o, t.style.width = h, t.style.height = a), u) {
            case 2:
        ...
        var n, o, r = s.call(i, t, e), a = r.orientation;
    ...
    i.blobSlice = a && function () {
    ...
    }, i.metaDataParsers = {jpeg: {65505: []}}, i.parseMetaData = function (t, e, n) {
        n = n || {};
        var o = this, r = n.maxMetaDataSize || 262144, s = {};
        !!(window.DataView && t && t.size >= 12 && "image/jpeg" === t.type && i.blobSlice) && i.readFile(i.blobSlice.call(t, 0, r), function (t) {
            if (t.target.error) return void e(s);
            var r, a, h, u, l = t.target.result, c = new DataView(l), d = 2, p = c.byteLength - 4, f = d;
            if (65496 === c.getUint16(0)) {
                for (; d < p && ((r = c.getUint16(d)) >= 65504 && r <= 65519 || 65534 === r) && (a = c.getUint16(d + 2) + 2, !(d + a > c.byteLength));) {
                    if (h = i.metaDataParsers.jpeg[r]) for (u = 0; u < h.length; u += 1) h[u].call(o, c, d, a, s, n);
                    d += a, f = d
                }
        ...
        return this
    }, i.ExifMap.prototype.map = {Orientation: 274}, i.ExifMap.prototype.get = function (t) {
        ...
        var a, h, u, l, c, d, p = i.exifTagTypes[o];
        if (p && (a = p.size * r, !((h = a > 4 ? e + t.getUint32(n + 8, s) : n + 8) + a > t.byteLength))) {
            if (1 === r) return p.getValue(t, h, s);
            for (u = [], l = 0; l < r; l += 1) u[l] = p.getValue(t, h + l * p.size, s);
            if (p.ascii) {
                for (c = "", l = 0; l < u.length && "\0" !== (d = u[l]); l += 1) c += d;
                return c
            }
            return u
        }
        ...
        var r, s, a;
        if (!(i + 6 > t.byteLength || (r = t.getUint16(i, n), (s = i + 2 + 12 * r) + 4 > t.byteLength))) {
            for (a = 0; a < r; a += 1) this.parseExifTag(t, e, i + 2 + 12 * a, n, o);
        ...
        if (!r.disableExif) {
            ...
            if (1165519206 === t.getUint32(e + 4) && !(u + 8 > t.byteLength) && 0 === t.getUint16(e + 8)) {
                ...
                42 === t.getUint16(u + 2, s) && (a = t.getUint32(u + 4, s), o.exif = new i.ExifMap, a = i.parseExifTags(t, u, u + a, s, o), a && !r.disableExifThumbnail && (h = {exif: {}}, a = i.parseExifTags(t, u, u + a, s, h), h.exif[513] && (o.exif.Thumbnail = i.getExifThumbnail(t, u + h.exif[513], h.exif[514]))), o.exif[34665] && !r.disableExifSub && i.parseExifTags(t, u, u + o.exif[34665], s, o), o.exif[34853] && !r.disableExifGps && i.parseExifTags(t, u, u + o.exif[34853], s, o))
            }
        }
    }, i.metaDataParsers.jpeg[65505].push(i.parseExifData);
    var h = function () {
        var t = [], e = [], i = [], n = "transform", o = window.getComputedStyle(document.documentElement, "")
        ;"webkit" === (Array.prototype.slice.call(o).join("").match(/-(moz|webkit|ms)-/) || "" === o.OLink && ["", "o"])[1] && (n = "webkitTransform");
        var r = function (t, e, i) {
                ...
                if (void 0 !== n.length) {
                    ...
                    }, r = 0, h = n.length; r < h; ++r) "string" == typeof e ? o.chainers.push(a(n[r], e, s(i, r, h))) : o.chainers.push(a(n[r], s(e, r, h), i));
                    return o
                }
                return "string" == typeof e ? a(n, e, s(i, 0, 1)) : a(n, s(e, 0, 1), i)
            }, s = function (t, e, i) {
                if (!t) return t;
                var n = X(t);
                ...
                var o = J(t.allDone), r = J(t.complete);
                return (r || o) && (n.complete = function () {
                ...
                }), ["position", "rotation", "skew", "rotationPost", "scale", "width", "height", "opacity", "fromPosition", "fromRotation", "fromSkew", "fromRotationPost", "fromScale", "fromWidth", "fromHeight", "fromOpacity", "transformOrigin", "duration", "delay"].forEach(function (o) {
                    J(t[o]) && (n[o] = t[o](e, i))
                }), n
            }, a = function (t, i, n) {
                function o(i) {
                    if (_.tick(i), _.updateElement(t), !_.isStopped()) return _.completed() ? void (r.loop > 1 && !_.isStopped() ? (r.loop -= 1, _.restart(), w(o)) : (r.complete && r.complete.call(t), y.length && (r = y.pop(), l = g(r, d, !0), d = g(r, X(d)), r = v(l, d, r), _ = x(r), e.push([t, _]), _.tick(i), w(o)))) : w(o)
                }

                if ("attention" === i) return h(t, n);
                if ("stop" === i) return u(t);
                if ("detach" === i) return c(t);
                var r = i;
                f();
                var a = m(t), l = a;
                l = g(r, l, !0);
                ...
                d = g(r, d);
                var p = v(l, d, r), _ = x(p);
                e.push([t, _]), _.updateElement(t, !0);
                var y = [], b = {
                    snabbt: function (t) {
                ...
                return w(o), r.manual ? _ : b
            }, h = function (t, i) {
                function n(e) {
                    r.tick(e), r.updateElement(t), r.completed() ? (i.callback && i.callback(t), i.loop && i.loop > 1 && (i.loop--, r.restart(), w(n))) : w(n)
                }
                ...
                var n, o, r = [], s = e.concat(i), a = s.length;
                for (o = 0; o < a; ++o) n = s[o][0], (t.contains(n) || t === n) && r.push(n);
                for (a = r.length, o = 0; o < a; ++o) d(r[o])
            }, d = function (t) {
                u(t);
                var n = l(e, t);
                n >= 0 && e.splice(n, 1), (n = l(i, t)) >= 0 && i.splice(n, 1)
            }, p = function (t, e) {
                for (var i = 0, n = t.length; i < n; ++i) {
                    var o = t[i], r = o[0], s = o[1];
                    if (r === e) {
                ...
                var n = "position", o = "rotation", r = "skew", s = "rotationPost", a = "scale", h = "scalePost",
                    u = "width", l = "height", c = "opacity";
                return i && (n = "fromPosition", o = "fromRotation", r = "fromSkew", s = "fromRotationPost", a = "fromScale", h = "fromScalePost", u = "fromWidth", l = "fromHeight", c = "fromOpacity"), e.position = j(t[n], e.position), e.rotation = j(t[o], e.rotation), e.rotationPost = j(t[s], e.rotationPost), e.skew = j(t[r], e.skew), e.scale = j(t[a], e.scale), e.scalePost = j(t[h], e.scalePost), e.opacity = t[c], e.width = t[u], e.height = t[l], e
            }, v = function (t, e, i) {
                return i.startState = t, i.endState = e, i
            },
            y = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                return setTimeout(t, 1e3 / 60)
            }, w = function (e) {
                0 === t.length && y(b), t.push(e)
            }, b = function (n) {
                for (var o = t.length, r = 0; r < o; ++r) t[r](n);
                t.splice(0, o);
                var s = e.filter(function (t) {
                    return t[1].completed()
                });
                i = i.filter(function (t) {
                    for (var e = 0, i = s.length; e < i; ++e) if (t[0] === s[e][0]) return !1;
                    return !0
                }), i = i.concat(s), e = e.filter(function (t) {
                    return !t[1].completed()
                }), 0 !== t.length && y(b)
            }, x = function (t) {
                var e = t.startState, i = t.endState, n = j(t.duration, 500), o = j(t.delay, 0), r = t.perspective,
                    s = P(j(t.easing, "linear"), t), a = 0 === n ? i.clone() : e.clone();
                t.transformOrigin;
                a.transformOrigin = t.transformOrigin;
                var h, u, l = 0, c = 0, d = !1, p = !1, f = t.manual, _ = 0, m = o / n;
                return u = t.valueFeeder ? q(t.valueFeeder, e, i, a) : W(e, i, a), {
                    stop: function () {
                        d = !0
                    }, isStopped: function () {
                        return d
                    }, finish: function (t) {
                        f = !1, l = c - n * _, h = t, s.resetFrom = _
                    }, rollback: function (t) {
                        f = !1, u.setReverse(), l = c - n * (1 - _), h = t, s.resetFrom = _
                    }, restart: function () {
                        l = void 0, s.resetFrom(0)
                    }, tick: function (t) {
                        if (!d) {
                            if (f) return c = t, void this.updateCurrentTransform();
                            if (l || (l = t), t - l > o) {
                                p = !0, c = t - o;
                        ...
                        if (p || e) {
                            var i = u.asMatrix(), n = u.getProperties();
                            V(t, i, r), G(t, n)
                        }
                    }
                }
                ...
                var i = M(t), n = !1, o = e.position, r = e.rotation, s = e.rotationPost, a = e.scale, h = e.skew, u = F({
                ...
                return {
                    stop: function () {
                        ...
                        V(t, u.asMatrix()), G(t, u.getProperties())
                    }, getCurrentState: function () {
                        return u
                    }, completed: function () {
                ...
                var e = j(t.startPosition, 0), i = j(t.equilibriumPosition, 1), n = j(t.initialVelocity, 0),
                    o = j(t.springConstant, .8), r = j(t.springDeceleration, .9), s = j(t.springMass, 10), a = !1;
                return {
                    tick: function (t) {
                        if (0 !== t && !a) {
                            n += -(e - i) * o / s, e += n, n *= r, Math.abs(e - i) < .001 && Math.abs(n) < .001 && (a = !0)
                        }
            ...
            }, T = {linear: k, ease: A, easeIn: C, easeOut: E}, P = function (t, e) {
                if ("spring" == t) return M(e);
                var i = t;
                J(t) || (i = T[t]);
                var n, o = i, r = 0;
                return {
                ...
                return D(t), {
                    data: t, asCSS: function () {
                        for (var e = "matrix3d(", i = 0; i < 15; ++i) Math.abs(t[i]) < 1e-4 ? e += "0," : e += t[i].toFixed(10) + ",";
                        return Math.abs(t[15]) < 1e-4 ? e += "0)" : e += t[15].toFixed(10) + ")", e
                    }, clear: function () {
                        D(t)
                    }, translate: function (n, o, r) {
                        return U(t, e), L(i, n, o, r), H(e, i, t), this
                    }, rotateX: function (n) {
                        return U(t, e), I(i, n), H(e, i, t), this
                    }, rotateY: function (n) {
                        return U(t, e), R(i, n), H(e, i, t), this
                    }, rotateZ: function (n) {
                        return U(t, e), O(i, n), H(e, i, t), this
                    }, scale: function (n, o) {
                        return U(t, e), B(i, n, o), H(e, i, t), this
                    }, skew: function (n, o) {
                        return U(t, e), z(i, n, o), H(e, i, t), this
                    }
                }
            }, H = function (t, e, i) {
                ...
                var e = N(), i = {opacity: void 0, width: void 0, height: void 0};
                return {
                    position: t.position,
                    rotation: t.rotation,
                ...
                var n = t, o = e, r = i, s = void 0 !== o.position, a = void 0 !== o.rotation,
                    h = void 0 !== o.rotationPost, u = void 0 !== o.scale, l = void 0 !== o.skew, c = void 0 !== o.width,
                    d = void 0 !== o.height, p = void 0 !== o.opacity;
                return {
                    tween: function (t) {
                        if (s) {
                            var e = o.position[0] - n.position[0], i = o.position[1] - n.position[1],
                                f = o.position[2] - n.position[2];
                            r.position[0] = n.position[0] + t * e, r.position[1] = n.position[1] + t * i, r.position[2] = n.position[2] + t * f
                        }
                        if (a) {
                            var _ = o.rotation[0] - n.rotation[0], m = o.rotation[1] - n.rotation[1],
                                g = o.rotation[2] - n.rotation[2];
                            r.rotation[0] = n.rotation[0] + t * _, r.rotation[1] = n.rotation[1] + t * m, r.rotation[2] = n.rotation[2] + t * g
                        }
                        if (h) {
                            var v = o.rotationPost[0] - n.rotationPost[0], y = o.rotationPost[1] - n.rotationPost[1],
                        ...
                        if (l) {
                            var b = o.scale[0] - n.scale[0], x = o.scale[1] - n.scale[1];
                            r.scale[0] = n.scale[0] + t * b, r.scale[1] = n.scale[1] + t * x
                        }
                        if (u) {
                            var S = o.skew[0] - n.skew[0], k = o.skew[1] - n.skew[1];
                            r.skew[0] = n.skew[0] + t * S, r.skew[1] = n.skew[1] + t * k
                        }
                        if (c) {
                        ...
                        if (d) {
                            var C = o.height - n.height;
                            r.height = n.height + t * C
                        }
                        if (p) {
                            var E = o.opacity - n.opacity;
                            r.opacity = n.opacity + t * E
                        }
                    }, asMatrix: function () {
                        return r.asMatrix()
                    }, getProperties: function () {
                ...
                var o = t(0, N()), r = e, s = i, a = n, h = !1;
                return {
                    tween: function (e) {
                        h && (e = 1 - e), o.clear(), o = t(e, o);
                        var i = s.width - r.width, n = s.height - r.height, u = s.opacity - r.opacity;
        ...
        function i(t, e, i, s, a, h) {
            var u, l, c, d, p, f, _, m, g, v, y, w, b, x, S, k, A, C, E, M, T, P, L, I, R = t.data, O = h + h + 1,
                z = s - 1, B = a - 1, D = h + 1, U = D * (D + 1) / 2, N = new n, H = N;
            for (c = 1; c < O; c++) if (H = H.next = new n, c == D) var F = H;
            H.next = N;
            var W = null, q = null;
            _ = f = 0;
            var j = o[h], V = r[h];
            for (l = 0; l < a; l++) {
                for (k = A = C = E = m = g = v = y = 0, w = D * (M = R[f]), b = D * (T = R[f + 1]), x = D * (P = R[f + 2]), S = D * (L = R[f + 3]), m += U * M, g += U * T, v += U * P, y += U * L, H = N, c = 0; c < D; c++) H.r = M, H.g = T, H.b = P, H.a = L, H = H.next;
                for (c = 1; c < D; c++) d = f + ((z < c ? z : c) << 2), m += (H.r = M = R[d]) * (I = D - c), g += (H.g = T = R[d + 1]) * I, v += (H.b = P = R[d + 2]) * I, y += (H.a = L = R[d + 3]) * I, k += M, A += T, C += P, E += L, H = H.next;
                for (W = N, q = F, u = 0; u < s; u++) R[f + 3] = L = y * j >> V, 0 != L ? (L = 255 / L, R[f] = (m * j >> V) * L, R[f + 1] = (g * j >> V) * L, R[f + 2] = (v * j >> V) * L) : R[f] = R[f + 1] = R[f + 2] = 0, m -= w, g -= b, v -= x, y -= S, w -= W.r, b -= W.g, x -= W.b, S -= W.a, d = _ + ((d = u + h + 1) < z ? d : z) << 2, k += W.r = R[d], A += W.g = R[d + 1], C += W.b = R[d + 2], E += W.a = R[d + 3], m += k, g += A, v += C, y += E, W = W.next, w += M = q.r, b += T = q.g, x += P = q.b, S += L = q.a, k -= M, A -= T, C -= P, E -= L, q = q.next, f += 4;
                _ += s
            }
            for (u = 0; u < s; u++) {
                for (A = C = E = k = g = v = y = m = 0, f = u << 2, w = D * (M = R[f]), b = D * (T = R[f + 1]), x = D * (P = R[f + 2]), S = D * (L = R[f + 3]), m += U * M, g += U * T, v += U * P, y += U * L, H = N, c = 0; c < D; c++) H.r = M, H.g = T, H.b = P, H.a = L, H = H.next;
                for (p = s, c = 1; c <= h; c++) f = p + u << 2, m += (H.r = M = R[f]) * (I = D - c), g += (H.g = T = R[f + 1]) * I, v += (H.b = P = R[f + 2]) * I, y += (H.a = L = R[f + 3]) * I, k += M, A += T, C += P, E += L, H = H.next, c < B && (p += s);
                for (f = u, W = N, q = F, l = 0; l < a; l++) d = f << 2, R[d + 3] = L = y * j >> V, L > 0 ? (L = 255 / L, R[d] = (m * j >> V) * L, R[d + 1] = (g * j >> V) * L, R[d + 2] = (v * j >> V) * L) : R[d] = R[d + 1] = R[d + 2] = 0, m -= w, g -= b, v -= x, y -= S, w -= W.r, b -= W.g, x -= W.b, S -= W.a, d = u + ((d = l + D) < B ? d : B) * s << 2, m += k += W.r = R[d], g += A += W.g = R[d + 1], v += C += W.b = R[d + 2], y += E += W.a = R[d + 3], W = W.next, w += M = q.r, b += T = q.g, x += P = q.b, S += L = q.a, k -= M, A -= T, C -= P, E -= L, q = q.next, f += s
            }
            return t
        }
    ...
    HTMLCanvasElement.prototype.toBlob || Object.defineProperty(HTMLCanvasElement.prototype, "toBlob", {
        value: function (t, e, i) {
            for (var n = atob(this.toDataURL(e, i).split(",")[1]), o = n.length, r = new Uint8Array(o), s = 0; s < o; s++) r[s] = n.charCodeAt(s);
    ...
    }, d = void 0, p = new Image;
    p.onload = function () {
        return d = p.naturalWidth > p.naturalHeight
    }, p.src = "data:image/jpg;base64,";
    var f = function () {
            return d
        }, _ = null, m = function () {
            return null === _ && (_ = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream), _
        }, g = function (t) {
            t.width = 1, t.height = 1, t.getContext("2d").fillRect(0, 0, 1, 1)
        }, v = function (t) {
            if (void 0 === t.dataset) {
                var e, i, n = {}, o = t.attributes;
                for (e in o) o.hasOwnProperty(e) && o[e].name && /^data-[a-z_\-\d]*$/i.test(o[e].name) && (i = y(o[e].name.substr(5)), n[i] = o[e].value);
                return n
            }
            return t.dataset
        }, y = function (t) {
            ...
            return {x: void 0 === t.offsetX ? t.layerX : t.offsetX, y: void 0 === t.offsetY ? t.layerY : t.offsetY}
        }, x = function (t, e) {
            var i, n = {}, o = e || {};
            for (i in t) t.hasOwnProperty(i) && (n[i] = void 0 === o[i] ? t[i] : o[i]);
            return n
        }, S = {ESC: 27, RETURN: 13}, k = {
            ...
            gif: "image/gif",
            bmp: "image/bmp"
        }, C = /(\.png|\.bmp|\.gif|\.jpg|\.jpe|\.jpg|\.jpeg)$/, E = function (t, e) {
            ...
            var i = Math.PI / 180 * e, n = Math.cos(i), o = Math.sin(i), r = t.x, s = t.y, a = t.x + t.width,
                h = t.y + t.height, u = n * (r - .5) + o * (s - .5) + .5, l = n * (s - .5) - o * (r - .5) + .5,
                c = n * (a - .5) + o * (h - .5) + .5, d = n * (h - .5) - o * (a - .5) + .5;
            u <= c ? (t.x = u, t.width = c - u) : (t.x = c, t.width = u - c), l <= d ? (t.y = l, t.height = d - l) : (t.y = d, t.height = l - d)
        }, I = function (t) {
            var e = P(t);
            ...
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "POST", i = arguments[2],
                n = arguments[3], o = arguments[4], r = arguments[5], s = arguments[6], a = new XMLHttpRequest;
            o && a.upload.addEventListener("progress", function (t) {
                o(t.loaded, t.total)
            }), a.open(e, t, !0), n && n(a, i), a.onreadystatechange = function () {
                if (4 === a.readyState && a.status >= 200 && a.status < 300) {
                    var t = a.responseText;
                    if (!t.length) return void r();
                    if (-1 !== t.indexOf("Content-Length")) return void s("file-too-big");
                    var e = void 0;
                    try {
                        e = JSON.parse(a.responseText)
                    } catch (t) {
                    }
                    if ("object" === (void 0 === e ? "undefined" : c(e)) && "failure" === e.status) return void s(e.message);
                    r(e || t)
                    ...
                    if ("object" === (void 0 === i ? "undefined" : c(i)) && "failure" === i.status) return void s(i.message);
                    s("fail")
                }
            }, a.send(i)
        }, N = function (t) {
            ...
            for (e in A) A.hasOwnProperty(e) && (i = A[e], -1 == t.indexOf(i) && t.push(i));
            return t
        }, W = function (t) {
            return "image/jpeg" === t
        }, q = function (t) {
            var e = void 0;
            for (e in A) if (A.hasOwnProperty(e) && A[e] === t) return e;
            return t
        }, j = function (t) {
            var e = void 0;
            for (e in A) if (A.hasOwnProperty(e) && -1 !== t.indexOf(A[e])) return A[e];
            return null
        }, V = function (t) {
            ...
            return t.getFullYear() + "-" + G(t.getMonth() + 1, "00") + "-" + G(t.getDate(), "00") + "_" + G(t.getHours(), "00") + "-" + G(t.getMinutes(), "00") + "-" + G(t.getSeconds(), "00")
        }, X = function (t) {
            return void 0 === t.name ? J(new Date) + "." + q(Y(t)) : t.name
        }, Y = function (t) {
            return t.type || "image/jpeg"
        }, $ = function (t) {
            return "string" != typeof t ? J(new Date) : V(t).split(".").shift()
        }, Z = function (t, e) {
            ...
            t = t + (-1 !== t.indexOf("?") ? "&" : "?") + "url=" + n;
            var s = new XMLHttpRequest;
            s.open("GET", t, !0), e(s), s.responseType = "json", s.onload = function () {
                if ("failure" === this.response.status) return void o(this.response.message);
                tt(this.response.body, i, r)
            }, s.send()
        }, tt = function (t, e, i, n) {
            ...
            o.open("GET", t, !0), e(o), o.responseType = "blob", o.onload = function (e) {
                if (o.status >= 200 && o.status < 300 || 0 === o.status && this.response instanceof Blob) {
                    var r = V(t), s = j(this.response.type);
                    C.test(r) || (r += "." + q(s));
                    var a = Z(this.response, r);
                    i(bt(a, s))
            ...
            for (var i = et(t), n = new ArrayBuffer(i.length), o = new Uint8Array(n), r = 0; r < i.length; r++) o[r] = i.charCodeAt(r);
            var s = kt(t);
            return void 0 === e && (e = J(new Date) + "." + q(s)), Z(nt(n, s), e)
        }, nt = function (t, e) {
            ...
            i.parseMetaData(t, function (r) {
                var s = {canvas: !0, crossOrigin: o};
                e && (s.maxWidth = e.width, s.maxHeight = e.height), r.exif && f() && (s.orientation = r.exif.get("Orientation")), i(t, function (t) {
                    if ("error" === t.type) return void n();
                    n(t, r)
                }, s)
            })
        }, rt = function (t, e, i) {
            var n, o, r, s;
            return e / t < i ? (s = e, r = s / i, n = .5 * (t - r), o = 0) : (r = t, s = r * i, n = 0, o = .5 * (e - s)), {
                x: n,
                y: o,
                height: s,
                width: r
            ...
            var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments[2], o = E("canvas"),
                r = i.rotation, s = i.crop, a = i.size, h = i.filters, u = i.minSize;
            if (s) {
                var l = r % 180 != 0, c = {width: l ? t.height : t.width, height: l ? t.width : t.height};
                ...
                var d = s.x / c.width, p = s.y / c.height, f = s.width / c.width, _ = s.height / c.height;
                o.width = Math.round(s.width), o.height = Math.round(s.height);
            ...
            if (a) {
                var g = a.width / o.width, v = a.height / o.height;
                e(o, Math.min(g, v), a, u), h.sharpen > 0 && ht(o, lt(h.sharpen))
            }
            n(o)
        }, at = function (t) {
            return t.getContext("2d").getImageData(0, 0, t.width, t.height)
        }, ht = function (t, e) {
            t.getContext("2d").putImageData(e(at(t), t.width, t.height), 0, 0)
        }, ut = function (t, e, i) {
            var n = document.createElement("canvas");
            n.width = t, n.height = e;
            var o = n.getContext("2d"), r = o.createImageData(n.width, n.height);
            return i && r.set(i.data), r
        }, lt = function (t) {
            return function (e, i, n) {
                for (var o = [0, -1, 0, -1, 5, -1, 0, -1, 0], r = Math.round(Math.sqrt(o.length)), s = .5 * r | 0, a = ut(i, n), h = a.data, u = e.data, l = n, c = void 0; l--;) for (c = i; c--;) {
                    for (var d = l, p = c, f = 4 * (l * i + c), _ = 0, m = 0, g = 0, v = 0, y = 0; y < r; y++) for (var w = 0; w < r; w++) {
                        var b = d + y - s, x = p + w - s;
                        if (b >= 0 && b < n && x >= 0 && x < i) {
                            var S = 4 * (b * i + x), k = o[y * r + w];
                            _ += u[S] * k, m += u[S + 1] * k, g += u[S + 2] * k, v += u[S + 3] * k
                        }
                    }
            ...
            pt(e) ? i.drawImage(t, 0, 0, e.width, e.height) : (e.width = t.width, e.height = t.height, i.drawImage(t, 0, 0))
        }, _t = function (t) {
            ...
            if (t && "" !== t.value) {
                ...
                if (t.value) {
                    var e = document.createElement("form"), i = t.parentNode, n = t.nextSibling;
            ...
            return i.name = t.name, i.lastModified = new Date(t.lastModified), i
        }, xt = function (t) {
            var e = wt(t);
            return e.input.file = bt(t.input.file), e.output.image = t.output.image, e
        }, St = function (t, e, i) {
            if (!t || !e) return null;
            var n = t;
            return "IMG" === t.nodeName && (n = document.createElement("canvas"), n.width = t.width, n.height = t.height, n.getContext("2d").drawImage(t, 0, 0)), n.toDataURL(e, W(e) && "number" == typeof i ? i / 100 : void 0)
        }, kt = function (t) {
            if (!t) return null;
            var e = t.substr(0, 16).match(/^.+;/);
            return e.length ? e[0].substring(5, e[0].length - 1) : null
        }, At = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], i = arguments[2], n = arguments[3],
                o = arguments[4], r = {
                    server: wt(t.server),
                    meta: wt(t.meta),
                    input: {
            ...
            return D("input", e) && !o && (r.input.image = St(t.input.image, t.input.type)), D("output", e) && (r.output = {
                name: n ? $(t.input.name) + "." + n : t.input.name,
                type: A[n] || t.input.type,
                width: t.output.width,
                height: t.output.height
            }, r.output.image = St(t.output.image, r.output.type, i), r.output.type = kt(r.output.image), "image/png" === r.output.type && (r.output.name = $(r.input.name) + ".png")), D("actions", e) && (r.actions = wt(t.actions)), r
        }, Ct = function (t, e, i) {
            var n = t.output.image, o = i ? $(t.input.name) + "." + i : t.input.name, r = A[i] || t.input.type;
            "image/png" === r && (o = $(t.input.name) + ".png"), n.toBlob(function (t) {
                if ("msSaveBlob" in window.navigator) return void window.navigator.msSaveBlob(t, o);
                var e = (window.URL || window.webkitURL).createObjectURL(t), i = E("a");
            ...
            var r = Lt(t, e, i, o), s = Lt(t, e, i, n), a = o - n <= 180 ? "0" : "1";
            return ["M", r.x, r.y, "A", i, i, 0, a, 0, s.x, s.y].join(" ")
        }, Rt = function (t, e, i, n) {
            return It(t, e, i, 0, 360 * n)
        }, Ot = function () {
            var e = {
                n: function (t, e, i, n) {
                    var o, r, s, a, h, u, l, c;
                    return s = t.y + t.height, o = B(e.y, 0, s), s - o < i.min.height && (o = s - i.min.height), h = n ? (s - o) / n : t.width, h < i.min.width && (h = i.min.width, o = s - h * n), l = .5 * (h - t.width), a = t.x - l, r = t.x + t.width + l, (a < 0 || Math.round(r) > Math.round(i.width)) && (c = Math.min(t.x, i.width - (t.x + t.width)), a = t.x - c, r = t.x + t.width + c, h = r - a, u = h * n, o = s - u), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l, c;
                    return o = t.y, s = B(e.y, o, i.height), s - o < i.min.height && (s = o + i.min.height), h = n ? (s - o) / n : t.width, h < i.min.width && (h = i.min.width, s = o + h * n), l = .5 * (h - t.width), a = t.x - l, r = t.x + t.width + l, (a < 0 || Math.round(r) > Math.round(i.width)) && (c = Math.min(t.x, i.width - (t.x + t.width)), a = t.x - c, r = t.x + t.width + c, h = r - a, u = h * n, s = o + u), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l, c;
                    return a = t.x, r = B(e.x, a, i.width), r - a < i.min.width && (r = a + i.min.width), u = n ? (r - a) * n : t.height, u < i.min.height && (u = i.min.height, r = a + u / n), l = .5 * (u - t.height), o = t.y - l, s = t.y + t.height + l, (o < 0 || Math.round(s) > Math.round(i.height)) && (c = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - c, s = t.y + t.height + c, u = s - o, h = u / n, r = a + h), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l, c;
                    return r = t.x + t.width, a = B(e.x, 0, r), r - a < i.min.width && (a = r - i.min.width), u = n ? (r - a) * n : t.height, u < i.min.height && (u = i.min.height, a = r - u / n), l = .5 * (u - t.height), o = t.y - l, s = t.y + t.height + l, (o < 0 || Math.round(s) > Math.round(i.height)) && (c = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - c, s = t.y + t.height + c, u = s - o, h = u / n, a = r - h), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l;
                    return a = t.x, s = t.y + t.height, r = B(e.x, a, i.width), r - a < i.min.width && (r = a + i.min.width), u = n ? (r - a) * n : B(s - e.y, i.min.height, s), u < i.min.height && (u = i.min.height, r = a + u / n), o = t.y - (u - t.height), (o < 0 || Math.round(s) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = s - o, h = u / n, r = a + h), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l;
                    return a = t.x, o = t.y, r = B(e.x, a, i.width), r - a < i.min.width && (r = a + i.min.width),
                        u = n ? (r - a) * n : B(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, r = a + u / n), s = t.y + t.height + (u - t.height), (o < 0 || Math.round(s) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), s = t.y + t.height + l, u = s - o, h = u / n, r = a + h), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l;
                    return r = t.x + t.width, o = t.y, a = B(e.x, 0, r), r - a < i.min.width && (a = r - i.min.width), u = n ? (r - a) * n : B(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, a = r - u / n), s = t.y + t.height + (u - t.height), (o < 0 || Math.round(s) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), s = t.y + t.height + l, u = s - o, h = u / n, a = r - h), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
                    ...
                    var o, r, s, a, h, u, l;
                    return r = t.x + t.width, s = t.y + t.height, a = B(e.x, 0, r), r - a < i.min.width && (a = r - i.min.width), u = n ? (r - a) * n : B(s - e.y, i.min.height, s), u < i.min.height && (u = i.min.height, a = r - u / n), o = t.y - (u - t.height), (o < 0 || Math.round(s) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = s - o, h = u / n, a = r - h), {
                        x: a,
                        y: o,
                        width: r - a,
                        height: s - o
            ...
            return function () {
                function i() {
                    ...
                    t(this, i), this._element = e, this._interaction = null, this._minWidth = 1, this._minHeight = 1, this._ratio = null, this._rect = {
                        x: 0,
                        y: 0,
                        width: 0,
                        height: 0
                ...
                return l(i, [{
                    key: "_init", value: function () {
                        ...
                        var o = E("button", "c");
                        this._element.appendChild(o), M(document, k.DOWN, this)
                    }
                }, {
                    ...
                    key: "resize", value: function (t, e, i, n) {
                        this._interaction = null, this._rect = {
                            x: B(t, 0, this._space.width - this._minWidth),
                            y: B(e, 0, this._space.height - this._minHeight),
                            width: B(i, this._minWidth, this._space.width),
                            height: B(n, this._minHeight, this._space.height)
                        }, this._rectChanged = !0, this._redraw(), this._element.dispatchEvent(new CustomEvent("change"))
                    }
                }, {
                    ...
                    key: "_onStartDrag", value: function (t) {
                        this._element.contains(t.target) && (t.preventDefault(), M(document, k.MOVE, this), M(document, k.UP, this), this._interaction = {
                    ...
                    key: "_onDrag", value: function (t) {
                        t.preventDefault();
                        var i = I(t), n = this._interaction.type;
                        "c" === n ? (this._rect.x = B(i.x - this._interaction.offset.x, 0, this._space.width - this._rect.width), this._rect.y = B(i.y - this._interaction.offset.y, 0, this._space.height - this._rect.height)) : e[n] && (this._rect = e[n](this._rect, {
                            x: i.x - this._space.x,
                            y: i.y - this._space.y
                        }, {
                            x: 0,
                    ...
                    key: "_onStopDrag", value: function (t) {
                        t.preventDefault(), T(document, k.MOVE, this), T(document, k.UP, this), this._interaction = null, this._element.setAttribute("data-dragging", "false"), this._element.dispatchEvent(new CustomEvent("change"))
                    }
                }, {
                    ...
                    key: "destroy", value: function () {
                        this._interaction = !1, this._rectChanged = !1, T(document, k.DOWN, this), T(document, k.MOVE, this), T(document, k.UP, this), Tt(this._element)
                    }
                }, {
                    ...
                    key: "area", get: function () {
                        return {
                            x: this._rect.x / this._space.width,
                            y: this._rect.y / this._space.height,
                            width: this._rect.width / this._space.width,
                            height: this._rect.height / this._space.height
                        }
                    }
                }, {
            ...
            var e = ["input", "change"], i = function () {
                ...
                return l(i, [{
                    key: "_init", value: function () {
                        var t = this;
                        this._element.className = "slim-image-editor", this._container = E("div", "slim-container"), this._wrapper = E("div", "slim-wrapper"), this._stage = E("div", "slim-stage"), this._container.appendChild(this._stage), this._cropper = new Ot, e.forEach(function (e) {
                            t._cropper.element.addEventListener(e, t)
                        }), this._stage.appendChild(this._cropper.element), this._previewWrapper = E("div", "slim-image-editor-preview slim-crop-preview"), this._previewBlurred = E("canvas", "slim-crop-blur"), this._previewWrapper.appendChild(this._previewBlurred), this._wrapper.appendChild(this._previewWrapper), this._previewMask = E("div", "slim-crop-mask"), this._preview = E("img"), this._previewMask.appendChild(this._preview), this._cropper.element.appendChild(this._previewMask), this._btnGroup = E("div", "slim-editor-btn-group"), i.Buttons.forEach(function (e) {
                            var i = O(e), n = t._options["button" + i + "Label"], o = t._options["button" + i + "Title"],
                                r = t._options["button" + i + "ClassName"],
                                s = E("button", "slim-editor-btn slim-btn-" + e + (r ? " " + r : ""));
                        ...
                        }), this._utilsGroup = E("div", "slim-editor-utils-group");
                        var n = E("button", "slim-editor-utils-btn slim-btn-rotate" + (this._options.buttonRotateClassName ? " " + this._options.buttonRotateClassName : ""));
                    ...
                    key: "_updateWrapperScale", value: function () {
                        if (this._wrapperRotation % 180 != 0) {
                            var t = this._container.offsetWidth, e = this._container.offsetHeight,
                                i = this._wrapper.offsetHeight, n = this._wrapper.offsetWidth, o = t / i;
                            o * n > e && (o = e / n), this._wrapperScale = o
                    ...
                    key: "_confirm", value: function () {
                        if (!this._rotating) {
                            var t = this._wrapperRotation % 180 != 0, e = this._cropper.area,
                                i = gt(e, t ? this._input.height : this._input.width, t ? this._input.width : this._input.height);
                    ...
                    key: "_rotate", value: function () {
                        ...
                        if (!this._rotating) {
                            ...
                            e && L(e, 90), this._updateWrapperScale(), this._hideCropper(), h(this._previewWrapper, {
                    ...
                    key: "_showCropper", value: function () {
                        h(this._stage, {easing: "ease", duration: 250, fromOpacity: 0, opacity: 1})
                    }
                }, {
                    key: "_hideCropper", value: function () {
                        h(this._stage, {duration: 0, fromOpacity: 0, opacity: 0})
                    }
                }, {
                    key: "_redrawCropMask", value: function () {
                        var t = this, e = this._wrapperRotation % 360, i = this._wrapperScale,
                            ...
                            o = this._cropper.area, r = {x: 0, y: 0};
                    ...
                    key: "open", value: function (t, e, i, n, o) {
                        ...
                        var s = this._wrapperRotation % 180 != 0, a = vt(i, s ? t.height : t.width, s ? t.width : t.height);
                        this._preview.onload = function () {
                            r._preview.onload = null, r._cropper.ratio = r.ratio, r._redraw(), r._redrawCropper(a), o(), r._element.style.opacity = ""
                        };
                        var h = dt(this._input, Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height) * this._options.devicePixelRatio);
                    ...
                    key: "_redrawCropper", value: function (t) {
                        var e = this._wrapperRotation % 180 != 0,
                            ...
                            n = this._wrapper.offsetWidth, o = this._wrapper.offsetHeight, r = this._container.offsetWidth,
                            s = this._container.offsetHeight;
                        this._updateWrapperScale();
                        var a = this._wrapperScale * (e ? o : n), h = this._wrapperScale * (e ? n : o),
                            u = e ? .5 * (r - a) : this._wrapper.offsetLeft, l = e ? .5 * (s - h) : this._wrapper.offsetTop;
                        ...
                        c = t ? {
                            ...
                            width: t.width * a,
                            height: t.height * h
                        } : rt(a, h, this._ratio || h / a), this._cropper.resize(c.x, c.y, c.width, c.height)
                    }
                }, {
                    key: "_redraw", value: function () {
                        ...
                        this._wrapper.style.cssText = "\n\t\t\t\tleft:" + r + "px;\n\t\t\t\ttop:" + s + "px;\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewBlurred.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._preview.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewSize = {
                            width: n,
                            height: o
                        }, this._blurredPreview || (this._previewBlurred.width = 300, this._previewBlurred.height = this._previewBlurred.width * t, ft(this._input, this._previewBlurred), _t(this._previewBlurred), this._blurredPreview = !0)
                    }
                }, {
                    ...
                    key: "destroy", value: function () {
                        var t = this;
                        Mt(this._btnGroup.children).forEach(function (e) {
            ...
            return function () {
                ...
                return l(i, [{
                    ...
                    key: "areValidDataTransferFiles", value: function (t) {
                        return !this._accept.length || !t || -1 !== this._accept.indexOf(t[0].type)
                    }
                }, {
                    key: "areValidDataTransferItems", value: function (t) {
                        return !this._accept.length || !t || (this._allowURLs && "string" === t[0].kind ? null : t[0].type && 0 === t[0].type.indexOf("application") ? null : -1 !== this._accept.indexOf(t[0].type))
                    }
                }, {
                    key: "reset", value: function () {
                    ...
                    key: "_onDrop", value: function (t) {
                        ...
                        if (e) this._element.files = [{remote: e}]; else {
                            if (!this.isValidDataTransfer(t.dataTransfer)) return this._element.dispatchEvent(new CustomEvent("file-invalid-drop")), void (this._dragPath = null);
                            this._element.files = t.dataTransfer.files
                        }
                        this._element.dispatchEvent(new CustomEvent("file-drop", {detail: b(t)})), this._element.dispatchEvent(new CustomEvent("change")), this._dragPath = null
                    }
                }, {
                    key: "_onDragOver", value: function (t) {
                        ...
                        if (null !== e && !e) return t.dataTransfer.dropEffect = "none", void this._element.dispatchEvent(new CustomEvent("file-invalid"));
                        this._dragPath || (this._dragPath = []), this._dragPath.push(b(t)), this._element.dispatchEvent(new CustomEvent("file-over", {
                            detail: {
                                x: z(this._dragPath).x,
                                y: z(this._dragPath).y
                            }
                        }))
                    }
                }, {
                    key: "_onDragLeave", value: function (t) {
                        this._element.dispatchEvent(new CustomEvent("file-out", {detail: b(t)})), this._dragPath = null
                    }
                }, {
                    key: "destroy", value: function () {
                        var t = this;
            ...
            return function () {
                ...
                return l(e, [{
                    key: "_init", value: function () {
                        this._element = E("div", "slim-popover"), this._element.setAttribute("data-state", "off"), document.body.appendChild(this._element), this._element.addEventListener("touchmove", function (t) {
                            t.preventDefault()
                        }, !0)
                    }
                }, {
                    ...
                    key: "hide", value: function () {
                        ...
                        h(this._element, {
                            fromOpacity: 1, opacity: 0, duration: 500, complete: function () {
                                N(t._element), t._element.setAttribute("data-state", "off"), e()
                            }
                        })
                    }
                }, {
        ...
        }, Ht = {AUTO: "auto", INITIAL: "initial", MANUAL: "manual"}, Ft = ["x", "y", "width", "height"],
        Wt = ["file-invalid-drop", "file-invalid", "file-drop", "file-over", "file-out", "click"],
        qt = ["cancel", "confirm"], jt = ["remove", "edit", "download"], Vt = null, Gt = 0,
        ...
        Xt = function (t) {
            ...
            return l(e, [{
                key: "setRotation", value: function (t, e) {
                    if ("number" == typeof t || t % 90 == 0) {
                        ...
                        if (this._data.input.image) {
                            ...
                            this._data.actions.crop = rt(n, o, this._ratio), this._data.actions.crop.type = Ht.AUTO
                        }
                ...
                key: "setSize", value: function (t, e) {
                    "string" == typeof t && (t = Xt(t)), t && t.width && t.height && (this._options.size = wt(t), this._data.actions.size = wt(t), this._data.input.image && e && this._manualTransform(e))
                }
            }, {
                key: "setForceSize", value: function (t, e) {
                    "string" == typeof t && (t = Xt(t)), t && t.width && t.height && (this._options.size = wt(t), this._options.forceSize = wt(t), this._data.actions.size = wt(t), this.setRatio(this._options.forceSize.width + ":" + this._options.forceSize.height, e))
                }
            }, {
                key: "setRatio", value: function (t, e) {
                    var i = this;
                    if (t && "string" == typeof t && (this._options.ratio = t, this._isFixedRatio())) {
                        var n = Ut(this._options.ratio, ":");
                        this._ratio = n[1] / n[0], this._data.input.image && e ? this._cropAuto(function (t) {
                            i._scaleDropArea(i._ratio), e && e(t)
                        }) : (this._data.input.image && (this._data.actions.crop = rt(this._data.input.image.width, this._data.input.image.height, this._ratio), this._data.actions.crop.type = Ht.AUTO), this._scaleDropArea(this._ratio), e && e(null))
                    }
                }
            }, {
                ...
                key: "load", value: function (t) {
                    ...
                    "function" == typeof e ? i = e : (this._options.crop = e.crop, this._options.rotation = e.rotation, this._initialRotation = e.rotation && e.rotation % 90 == 0 ? e.rotation : null, this._initialCrop = this._options.crop), this._load(t, i, {blockPush: e.blockPush})
                }
            }, {
                ...
                key: "_isAutoCrop", value: function () {
                    return this._data.actions.crop.type === Ht.AUTO
                }
            }, {
                key: "_toggleButton", value: function (t, e) {
                    Et('.slim-btn[data-action="' + t + '"]', e, this._element)
                }
            }, {
                ...
                key: "_addState", value: function (t) {
                    D(t, this._state) || (this._state.push(t), this._updateState())
                }
            }, {
                ...
                key: "_resetData", value: function () {
                    if (this._data.input && this._data.output) {
                        var t = this._data.input.image, e = this._data.output.image;
                        t && "CANVAS" === t.nodeName && g(t), e && "CANVAS" === e.nodeName && g(e)
                    }
                    this._data = {
                        server: null,
                        meta: wt(this._options.meta),
                    ...
                    }, this._output && (this._output.value = ""), yt(this._getFileInput())
                }
            }, {
                key: "_init", value: function () {
                    var t = this;
                    if (this._isInitialising = !0, this._addState("empty"), D("input", this._options.post) && (this._inputReference = "slim_input_" + this._uid), this._input = this._getInputElement(), this._input || (this._input = E("input"), this._input.type = "file", this._element.appendChild(this._input)), this._isRequired = !0 === this._input.required, this._output = this._element.querySelector("input[type=hidden]"), this._output) {
                        var e = null;
                        try {
                    ...
                    } else this._output = E("input"), this._output.type = "hidden", this._output.name = this._input.name || this._options.defaultInputName, this._element.appendChild(this._output);
                    this._input.removeAttribute("name");
                    var n = E("div", "slim-area"), o = this._getInitialImage(), r = (o || {}).src,
                    ...
                    if (this._isImageOnly()) n.innerHTML = "\n\t\t\t\t" + Jt + '\n\t\t\t\t\n<div class="slim-upload-status"></div>\n\n\t\t\t\t' + a + '\n\t\t\t\t<div class="slim-status"><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t"; else {
                        D("input", this._options.post) && (this._data.input.field = this._inputReference, this._options.service || (this._input.name = this._inputReference));
                        var h = void 0;
                        this._input.hasAttribute("accept") && "image/*" !== this._input.getAttribute("accept") ? h = this._input.accept.split(",").map(function (t) {
                            return t.trim()
                        }).filter(function (t) {
                            return t.length > 0
                        }) : (h = F(), this._input.setAttribute("accept", h.join(","))), this._imageHopper = new Bt, this._imageHopper.accept = h, this._imageHopper.allowURLs = "string" == typeof this._options.fetcher, this._element.appendChild(this._imageHopper.element), Wt.forEach(function (e) {
                            t._imageHopper.element.addEventListener(e, t)
                        }), n.innerHTML = "\n\t\t\t\t" + Jt + '\n\t\t\t\t\n<div class="slim-upload-status"></div>\n\n\t\t\t\t<div class="slim-drip"><span><span></span></span></div>\n\t\t\t\t<div class="slim-status"><div class="slim-label">' + (this._options.label || "") + '</div><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t\t" + a + "\n\t\t\t", this._input.addEventListener("change", this)
                    }
                    if (this._element.appendChild(n), this._btnGroup = E("div", "slim-btn-group"), this._btnGroup.style.display = "none", this._element.appendChild(this._btnGroup), jt.filter(function (e) {
                        return t._isButtonAllowed(e)
                    }).forEach(function (e) {
                        var i = O(e), n = t._options["button" + i + "Label"], o = t._options["button" + i + "Title"] || n,
                            r = t._options["button" + i + "ClassName"],
                            s = E("button", "slim-btn slim-btn-" + e + (r ? " " + r : ""));
                        s.innerHTML = n, s.title = o, s.type = "button", s.addEventListener("click", t), s.setAttribute("data-action", e), t._btnGroup.appendChild(s)
                    }), this._isFixedRatio()) {
                        var u = Ut(this._options.ratio, ":");
                ...
                key: "_onInit", value: function () {
                    ...
                    var e = function () {
                        var e = setTimeout(function () {
                            Yt(t._timers, e), t._options.didInit.apply(t, [t.data, t])
                        }, 0);
                        t._timers.push(e)
                    };
                ...
                key: "_updateProgress", value: function (t) {
                    if (t = Math.min(.99999, t), this._element && this._progressEnabled) {
                        ...
                        if (e) {
                            ...
                            .5 * i < o || (n[0].setAttribute("d", Rt(.5 * i, .5 * i, .5 * i - o, .9999)), n[1].setAttribute("d", Rt(.5 * i, .5 * i, .5 * i - o, t)))
                        }
                    }
                }
            }, {
                ...
                key: "_startProgressLoop", value: function () {
                    if (this._element) {
                        ...
                        if (t) {
                            ...
                            h(t, "stop"), h(t, {
                                rotation: [0, 0, -2 * Math.PI * 1e3], easing: "linear", duration: 1e6
                            }), h(e, {fromOpacity: 0, opacity: 1, duration: 250})
                        }
                    }
                }
            }, {
                ...
                key: "_throwError", value: function (t) {
                    ...
                    e || (e = E("div", "slim-error"), this._element.querySelector(".slim-status").appendChild(e)), e.innerHTML = t, this._options.didThrowError.apply(this, [t])
                }
            }, {
                ...
                key: "_onClick", value: function (t) {
                    ...
                    switch (n.getAttribute("data-action")) {
                        case"remove":
                            removeImage(this._element.getAttribute("data-file-name"));
                ...
                key: "_onInvalidFile", value: function () {
                    var t = this._imageHopper.accept.map(q), e = this._options.statusFileType.replace("$0", t.join(", "));
                    this._throwError(e)
                }
            }, {
                ...
                key: "_onFileOver", value: function (t) {
                    ...
                    var e = this._getDrip(), i = h.createMatrix();
                ...
                key: "_onDropFile", value: function (t) {
                    ...
                    var i = this._getDrip(), n = h.createMatrix();
                    n.translate(t.detail.x, t.detail.y, 0), h.setElementTransform(i, n);
                    var o = this._imageHopper.dragPath.length, r = this._imageHopper.dragPath[o - Math.min(10, o)],
                        s = t.detail.x - r.x, a = t.detail.y - r.y;
                    h(i, {
                        ...
                        duration: 200,
                        complete: function () {
                            N(i.firstChild), e._load(t.target.files[0])
                        }
                    })
                }
            }, {
                ...
                key: "_load", value: function (t, e) {
                    ...
                    if (!this._isBeingDestroyed) {
                        ...
                        if ("string" == typeof t) return void (Q(t) ? this._load(it(t), e, n) : (!function () {
                        ...
                        }(), tt(t, this._options.willLoad, function (t) {
                            i._load(t, e, n)
                        }, function (t) {
                            setTimeout(function () {
                                o(), i._onLocalURLProblem("<p>" + t + "</p>"), e && e.apply(i, ["local-url-problem"])
                            }, 500)
                        })));
                        if (void 0 !== t.remote) return Q(t.remote) ? void this._load(it(t.remote), e, n) : void (this._options.fetcher && K(this._options.fetcher, this._options.willFetch, this._options.willLoad, t.remote, function (t) {
                            o(), i._onRemoteURLProblem("<p>" + t + "</p>"), e && e.apply(i, ["remote-url-problem"])
                        }, function (t) {
                            i._load(t, e, n)
                        }));
                        var r = t;
                        if (this._imageHopper && -1 === this._imageHopper.accept.indexOf(r.type)) return o(), this._onInvalidFile(), void (e && e.apply(this, ["file-invalid"]));
                        if (r.size && this._options.maxFileSize && H(r.size) > this._options.maxFileSize) return o(), this._onOverWeightFile(), void (e && e.apply(this, ["file-too-big"]));
                        this._imageEditor && this._imageEditor.dirty(), this._data.input.name = n && n.name ? n.name : X(r), this._data.input.type = Y(r), this._data.input.size = r.size, this._data.input.file = r;
                        var s = this._options.internalCanvasSize;
                        m() && (s = this._options.internalCanvasSizeLowMemory), ot(r, s, function (t, o) {
                            var s = function () {
                            ...
                            if (!t) return s(), void (e && e.apply(i, ["file-not-found"]));
                            if (!mt(t, i._options.minSize)) return s(), i._onImageTooSmall(), void (e && e.apply(i, ["image-too-small"]));
                            var a = i._options.didLoad.apply(i, [r, t, o, i]);
                            if (!0 !== a) return s(), !1 !== a && i._throwError(a), void (e && e.apply(i, [a]));
                            ...
                            i._options.willLoadCanvas.apply(i, [t, function (t) {
                ...
                key: "_loadCanvas", value: function (t, e, i, n) {
                    ...
                    if (n || (n = {}), !this._isBeingDestroyed) {
                        m() ? (this._data.input.image = new Image, this._data.input.image.src = t.toDataURL()) : this._data.input.image = t, this._data.input.width = t.width, this._data.input.height = t.height, this._initialRotation && (this._data.actions.rotation = this._initialRotation, this._initialRotation = null);
                        var r = this._data.actions.rotation % 180 != 0;
                        this._isFixedRatio() || (this._initialCrop ? this._ratio = this._initialCrop.height / this._initialCrop.width : this._ratio = r ? t.width / t.height : t.height / t.width, this._scaleDropArea(this._ratio));
                        var s = function () {
                            o._options.size && (o._data.actions.size = {
                                ...
                                var r = o._getIntro(), s = r.offsetWidth / t.width, a = !1;
                                ...
                                var h = "auto" === o._options.devicePixelRatio ? window.devicePixelRatio : o._options.devicePixelRatio,
                                    u = dt(t, s * h);
                                r.src = "", r.src = u.toDataURL(), g(u), u = null, r.onload = function () {
                                    r.onload = null, o._isBeingDestroyed || e && e(a)
                                }
                            })
                        };
                        this._initialCrop ? (this._data.actions.crop = wt(this._initialCrop), this._data.actions.crop.type = Ht.INITIAL, this._initialCrop = null, s()) : this._options.willCropInitial.apply(this, [this.data, function (e) {
                            e ? (o._data.actions.crop = e, o._data.actions.crop.type = Ht.INITIAL) : (o._data.actions.crop = rt(r ? t.height : t.width, r ? t.width : t.height, o._ratio), o._data.actions.crop.type = Ht.AUTO), s()
                        }, this])
                    }
                }
            }, {
                key: "_applyTransforms", value: function (t, e) {
                    var i = this;
                    this._data.output.image && g(this._data.output.image);
                    var n = wt(this._data.actions);
                    n.filters = {sharpen: this._options.filterSharpen / 100}, this._options.forceMinSize ? n.minSize = this._options.minSize : n.minSize = {
                        width: 0,
                        height: 0
                    }, st(t, n, function (t) {
                        var n = t;
                        if (i._options.forceSize || i._options.size && 1 == ct(i._options.size, t)) {
                            n = E("canvas"), n.width = i._options.size.width, n.height = i._options.size.height;
                            n.getContext("2d").drawImage(t, 0, 0, i._options.size.width, i._options.size.height), g(t)
                        }
                        if (i._options.forceMinSize && i._options.size && i._options.minSize.width === i._options.size.width && i._options.minSize.height === i._options.size.height && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                            var o = Math.max(n.width, i._options.minSize.width),
                                r = Math.max(n.height, i._options.minSize.height);
                            n = E("canvas"), n.width = o, n.height = r;
                            n.getContext("2d").drawImage(t, 0, 0, o, r), g(t)
                        }
                        if (i._options.forceMinSize && 1 === i._ratio && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                            n = E("canvas"), n.width = i._options.minSize.width, n.height = i._options.minSize.height;
                            n.getContext("2d").drawImage(t, 0, 0, n.width, n.height), g(t)
                        }
                ...
                key: "_appendEditor", value: function () {
                    var t = this;
                    this._imageEditor || (this._imageEditor = new zt(E("div"), {
                        ...
                        buttonConfirmLabel: 'تایید',
                        // buttonConfirmLabel: this._options.buttonConfirmLabel,
                        buttonCancelLabel: 'انصراف',
                        // buttonCancelLabel: this._options.buttonCancelLabel,
                        buttonRotateLabel: 'چرخش',
                        // buttonRotateLabel: this._options.buttonRotateLabel,
                        buttonConfirmTitle: 'تایید',
                ...
                key: "_onConfirm", value: function (t) {
                    ...
                    i ? this._startProgress(function () {
                        e._updateProgress(.1)
                    }) : this._startProgressLoop(), this._removeState("editor"), this._addState("busy"), this._output.value = "", this._data.actions.rotation = t.detail.rotation, this._data.actions.crop = t.detail.crop, this._data.actions.crop.type = Ht.MANUAL, this._applyTransforms(this._data.input.image, function (t) {
                        e._options.didConfirm.apply(e, [e.data, e]);
                        var n = e._getInOut(), o = "out" === n[0].className ? n[0] : n[1], r = o === n[0] ? n[1] : n[0];
                        o.className = "in", o.style.opacity = "0", o.style.zIndex = "2", r.className = "out", r.style.zIndex = "1";
                        var s = "auto" === e._options.devicePixelRatio ? window.devicePixelRatio : e._options.devicePixelRatio,
                            a = dt(t, o.offsetWidth / t.width * s);
                        o.src = "", o.src = a.toDataURL(), g(a), a = null, o.onload = function () {
                            o.onload = null, "free" === e._options.ratio && (e._ratio = o.naturalHeight / o.naturalWidth, e._scaleDropArea(e._ratio)), e._hideEditor();
                            var t = setTimeout(function () {
                                Yt(e._timers, t), e._showPreview(o, function () {
                ...
                key: "_cropAuto", value: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function (t) {
                        ...
                        i = rt(e ? this._data.input.image.height : this._data.input.image.width, e ? this._data.input.image.width : this._data.input.image.height, this._ratio);
                    this._crop(i.x, i.y, i.width, i.height, t, Ht.AUTO)
                }
            }, {
                key: "_crop", value: function (t, e, i, n) {
                    var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : function (t) {
                    }, r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : Ht.MANUAL;
                ...
                key: "_manualTransform", value: function (t) {
                    ...
                    this._startProgressLoop(), this._addState("busy"), this._applyTransforms(this._data.input.image, function (i) {
                        var n = e._getInOut(), o = "out" === n[0].className ? n[0] : n[1], r = o === n[0] ? n[1] : n[0];
                        o.className = "in", o.style.opacity = "1", o.style.zIndex = "2", r.className = "out", r.style.zIndex = "0";
                        var s = "auto" === e._options.devicePixelRatio ? window.devicePixelRatio : e._options.devicePixelRatio,
                            a = dt(i, o.offsetWidth / i.width * s);
                        o.src = "", o.src = a.toDataURL(), g(a), a = null, o.onload = function () {
                ...
                key: "_storeServerResponse", value: function (t) {
                    this._isRequired && (this._input.required = !1), this._data.server = t, this._output.value = "object" === (void 0 === t ? "undefined" : c(t)) ? JSON.stringify(this._data.server) : t
                }
            }, {
                ...
                key: "_upload", value: function (t, e) {
                    ...
                    this.requestOutput(function (t, n) {
                        var o = i._element.querySelector(".slim-upload-status"), r = i._options.willRequest,
                            s = function (t, e) {
                                i._updateProgress(Math.max(.1, t / e))
                            }, a = function (t) {
                                var n = setTimeout(function () {
                                    if (Yt(i._timers, t), !i._isBeingDestroyed) {
                                        o.innerHTML = i._options.statusUploadSuccess, o.setAttribute("data-state", "success"), o.style.opacity = 1;
                                        var t = setTimeout(function () {
                                            Yt(i._timers, t), o.style.opacity = 0
                                        }, 2e3);
                                        i._timers.push(t)
                                    }
                                }, 250);
                                ...
                                var r = setTimeout(function () {
                                    Yt(i._timers, r), o.innerHTML = n, o.setAttribute("data-state", "error"), o.style.opacity = 1
                                }, 250);
                                i._timers.push(r), e(t)
                            };
                        "string" == typeof i._options.service ? U(i._options.service, i._options.uploadMethod, n, r, s, a, h) : "function" == typeof i._options.service && i._options.service.apply(i, ["file" === i._options.serviceFormat ? t : n, s, a, h, i])
                    }, t)
                }
            }, {
                key: "requestOutput", value: function (t, e) {
                    var n = this;
                    if (!this._data.input.file) return void t(null, null);
                    e || (e = this.dataBase64), i.parseMetaData(this._data.input.file, function (o) {
                        var r = [], s = new FormData;
                        if (D("input", n._options.post) && (r.push(n._data.input.file), s.append(n._inputReference, n._data.input.file, n._data.input.file.name)), D("output", n._options.post) && null !== n._data.output.image && !1 === n._options.uploadBase64) {
                            var a = it(e.output.image, e.output.name);
                            if (o.imageHead && n._options.copyImageHead) try {
                                a = new Blob([o.imageHead, i.blobSlice.call(a, 20)], {type: kt(e.output.image)}), a = Z(a, e.output.name)
                            } catch (t) {
                            }
                            r.push(a);
                ...
                key: "_showEditor", value: function () {
                    Vt.className = this._options.popoverClassName, Vt.show(), this._imageEditor.show()
                }
            }, {
                ...
                key: "_hideButtons", value: function (t) {
                    ...
                    if (this._btnGroup) {
                        var i = {
                            fromScale: [1, 1], scale: [.85, .85], fromOpacity: 1, opacity: 0, allDone: function () {
                ...
                key: "_hideStatus", value: function () {
                    this._element.querySelector(".slim-upload-status").style.opacity = 0
                }
            }, {
                ...
                key: "_doRemove", value: function (t) {
                    ...
                    if (!this._isImageOnly()) {
                        ...
                        var o = setTimeout(function () {
                            Yt(e._timers, o), e._isBeingDestroyed || (e._hideButtons(function () {
                ...
                key: "_doDownload", value: function () {
                    this._data.output.image && Ct(this._data, this._options.jpegCompression, this._options.forceType)
                }
            }, {
                key: "_doDestroy", value: function () {
                    ...
                    this._isBeingDestroyed = !0, this._timers.forEach(function (t) {
                        clearTimeout(t)
                    }), this._timers = [], h(this._element, "detach"), this._imageHopper && (Wt.forEach(function (t) {
                        e._imageHopper.element.removeEventListener(t, e)
                    }), this._imageHopper.destroy(), this._imageHopper = null), this._imageEditor && (qt.forEach(function (t) {
                        e._imageEditor.element.removeEventListener(t, e)
                    }), this._imageEditor.destroy(), this._imageEditor = null), Mt(this._btnGroup.children).forEach(function (t) {
                    ...
                    }), Gt = Math.max(0, Gt - 1), Vt && 0 === Gt && (Vt.destroy(), Vt = null);
                    var n = this._data.input.image, o = this._data.output.image;
                    n && "CANVAS" === n.nodeName && g(n), o && "CANVAS" === o.nodeName && g(o), this._originalElement = null, this._element = null, this._input = null, this._output = null, this._btnGroup = null, this._options = null
                }
            }, {
                ...
                key: "options", value: function () {
                    var t = {
                        ...
                        internalCanvasSizeLowMemory: {width: 4096, height: 4096},
                        copyImageHead: !1,
                        rotateButton: !0,
                        popoverClassName: null,
                        label: "<p>عکس خود را رها کنید</p>",
                        labelLoading: "<p>بارگذاری عکس...</p>",
                        statusFileType: "<p>فرمت فایل  : $0.</p>",
                        statusFileSize: "<p>سایز فایل بالا است, حداکثر سایز : $0 MB.</p>",
                        statusNoSupport: "<p>مرورگر شما پشتیبانی نمیکند</p>",
                        statusImageTooSmall: "<p>سایز فایل کم است, حدق سایز : $0 pixels.</p>",
                        statusContentLength: '<span class="slim-upload-status-icon"></span> حجم بالای فایل',
                        statusUnknownResponse: '<span class="slim-upload-status-icon"></span> خطای نامشخص',
                        statusUploadSuccess: '<span class="slim-upload-status-icon"></span> ذخیره شد',
                    ...
                    return jt.concat(zt.Buttons).concat("rotate").forEach(function (e) {
                        var i = O(e);
    ...
    return function () {
        ...
        var i = [], n = function (t) {
            ...
            push: r,
            rotation: function (t) {
                return void 0 === t ? null : parseInt(t, 10)
            },
            crop: d,
            post: function (t) {
        ...
        jt.concat(zt.Buttons).concat("rotate").forEach(function (t) {
            var e = O(t);
            f.forEach(function (t) {
                p["button" + e + t] = o
            })
        }), $t.supported = function () {
            return !("[object OperaMini]" === Object.prototype.toString.call(window.operamini) || void 0 === window.addEventListener || void 0 === window.FileReader || !("slice" in Blob.prototype) || void 0 === window.URL || void 0 === window.URL.createObjectURL)
        }(), $t.parse = function (t) {
            var e, i, n, o = [];
            for (e = t.querySelectorAll(".slim:not([data-state])"), n = e.length; n--;) i = e[n], o.push($t.create(i, $t.getOptionsFromAttributes(i)));
            return o
        }, $t.getOptionsFromAttributes = function (t) {
            var e = v(t), i = {meta: {}};
            for (var n in e) {
                var o = p[n], r = e[n];
                o ? (r = o(r), r = null === r ? wt($t.options()[n]) : r, i[n] = r) : 0 === n.indexOf("meta") && (i.meta[R(n.substr(4))] = r)
            }
            return i
        }, $t.find = function (t) {
            ...
            if (!$t.find(t)) {
                e || (e = $t.getOptionsFromAttributes(t));
                var n = new $t(t, e);
                return i.push(n), n
            }
    ...
    return t.options = {toggleClass: null}, t.prototype = {
        _init: function () {
    ...
    return t.options = {defaultTab: null}, t.prototype = {
        _init: function () {
            ...
            return this._getTabs().map(function (t) {
            ...
            if (t) {
                ...
                if (!e && this._options.defaultTab) return void this._update(this._options.defaultTab);
                e.setAttribute("aria-selected", "true"), document.getElementById(t).style.display = "block"
            } else if (this._options.defaultTab) return void this._update(this._options.defaultTab)
        }
    }, t
}), define("ui/ScrollReveal", [], function () {
    var t = function (t, e) {
        this._element = t, this._options = e, this._element.dataset.state = "hidden", this._init()
    };
    return t.options = {treshold: null}, t.prototype = {
        _init: function () {
            var t = this;
            ...
            const t = this._options.treshold || window.innerHeight;
            window.scrollY > t ? this._reveal() : this._conceal()
        }, _conceal: function () {
