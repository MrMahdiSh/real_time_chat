...
(function ($) {
    ...
    $(".add-education").on('click', function () {
        ...
        var educationcontent = '<div class="row form-row education-cont">' +
            ...
            '<label>مدرک</label>' +
            '<input name="edu_title[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '<div class="col-12 col-md-6 col-lg-4">' +
            '<div class="form-group">' +
            '<label>دانشگاه/موسسه</label>' +
            '<input name="edu_university[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '<div class="col-12 col-md-6 col-lg-4">' +
            '<div class="form-group">' +
            '<label>سال اتمام</label>' +
            '<input name="edu_date[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>' +
    ...
    $(".add-experience").on('click', function () {
        ...
        var experiencecontent = '<div class="row form-row experience-cont">' +
            ...
            '<input name="ex_title[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '<div class="col-12 col-md-6 col-lg-4">' +
            '<div class="form-group">' +
            '<label>از</label>' +
            '<input name="ex_from[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '<div class="col-12 col-md-6 col-lg-4">' +
            '<div class="form-group">' +
            '<label>تا</label>' +
            '<input name="ex_to[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '<div class="col-12 col-md-6 col-lg-4">' +
            '<div class="form-group">' +
            '<label>نقش</label>' +
            '<input name="ex_role[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>' +
    ...
    $(".add-award").on('click', function () {
        ...
        var regcontent = '<div class="row form-row awards-cont">' +
            ...
            '<div class="form-group">' +
            '<label>جایزه</label>' +
            '<input name="rew_title[]" type="text" class="form-control">' +
            '</div>' +
            '</div>' +
            '<div class="col-12 col-md-5">' +
            '<div class="form-group">' +
            '<label>سال</label>' +
            '<input name="rew_date[]"  type="text" class="form-control">' +
            '</div>' +
            '</div>' +
