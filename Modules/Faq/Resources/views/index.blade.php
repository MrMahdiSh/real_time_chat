...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست سوالات'])
                            ...
                            @if(isset($data))
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="product-name">{{$item->question}}</td>


                                        <td class="product-action">
                                            @if(auth()->user()->can('Faq.edit'))
                                                <a href="{{route('Faq.edit',['Faq'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Faq.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('Faq.destroy',['Faq'=>$item->id])}}')">
                                                    <span class=""><i
