...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست صفحات'])
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('Page.status',['id'=>$item->id])}}">
                                        ...
                                        <td class="product-action">
                                            @if(auth()->user()->can('Page.edit'))
                                                <a href="{{route('Page.edit',['Page'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Page.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('Page.destroy',['Page'=>$item->id])}}')">
                                                    <span class=""><i
