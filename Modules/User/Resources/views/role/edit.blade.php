...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            {{--            @include('partials.breadcrumb',['title'=>'ویرایش نقش'])--}}
                                        ...
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span
                                                class="d-none d-sm-block">ویرایش نقش</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('Roles.update',['Role'=>$data->id])}}"
                                                            ...
                                                            @isset($packages)
                                                                @foreach($packages as $item)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        $index_user= !empty($index) ?  $data->permissions->where('id',$index->id)->first() : null;
                                                                        $create_user= !empty($create) ?  $data->permissions->where('id',$create->id)->first() : null;
                                                                        $edit_user= !empty($edit) ?  $data->permissions->where('id',$edit->id)->first() : null;
                                                                        $destroy_user= !empty($destroy) ?  $data->permissions->where('id',$destroy->id)->first() : null;
