...
@endphp
<div class="instagram_post col-12 col-lg-2" id="{{$id}}">
    <blockquote class="instagram-media" data-instgrm-captioned
        ...
        <div style="padding:16px;">
            <a href="<?= $permalink ?>?utm_source=ig_embed&amp;utm_campaign=loading"
            ...
            <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                ...
                <a href="https://www.instagram.com/<?= $username; ?>/?utm_source=ig_embed&amp;utm_campaign=loading"
                   ...
                   target="_blank">@<?= $username; ?></a> on
                <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;"
                      datetime="2020-01-10T10:37:11+00:00"><?= $timestamp ?></time>
            </p>
        </div>
    </blockquote>
</div>
