...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('partials.breadcrumb',['title'=>'تنظیمات تماس با ما'])
                                ...
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">تنظیمات تماس با ما</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('ContactUs.update',['ContactU'=>isset($data) ? $data->id : 0  ])}}"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{{isset($data) ? $data->contact_us_title : ''}}"
                                                                   id="contact_us_title">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   name="contact_us"
                                                                   value="{{isset($data) ? $data->contact_us : ''}}"
                                                                   id="contact_us">
                                                        </div>
                                                    </div>
                                                </div>
