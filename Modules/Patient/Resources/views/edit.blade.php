                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('Patient.update',['Patient'=>$data->id])}}"
                                              method="post" enctype="multiPatient/form-data">
...
@section('js')
    ...
    {!! JsValidator::formRequest('Modules\Patient\Http\Requests\PatientValidation', '#form'); !!}
