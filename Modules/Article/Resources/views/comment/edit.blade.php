...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('partials.breadcrumb',['title'=>'ویرایش نظر ثبت شده'])
                                ...
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">ویرایش نظر ثبت شده</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('ArticleComment.update',['ArticleComment'=>$data->id])}}"
                                            ...
                                            <p class="alert alert-info">{{$data->message}}</p>
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <textarea name="replay"
                                                                      id="editor">{{$data->replay}}</textarea>
