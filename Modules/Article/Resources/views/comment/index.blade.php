                            ...
                            @if(isset($data))
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="product-name">{{$item->article ? $item->article->title : ''}}</td>
                                        <td class="product-name">{{$item->user_id}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('ArticleComment.status',['id'=>$item->id])}}">
                                        ...
                                        <td class="product-action">
                                            ...
                                            @if(auth()->user()->can('Article.edit'))
                                                <a href="{{route('ArticleComment.edit',['ArticleComment'=>$item->id])}}"><span
                                            ...
                                            @if(auth()->user()->can('Article.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('ArticleComment.destroy',['ArticleComment'=>$item->id])}}')">
                                                    <span class=""><i
