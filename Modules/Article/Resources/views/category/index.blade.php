                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('ArticleCategory.status',['id'=>$item->id])}}">
                                        ...
                                        <td class="product-action">
                                            @if(auth()->user()->can('Article.edit'))
                                                <a href="{{route('ArticleCategory.edit',['ArticleCategory'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Article.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('ArticleCategory.destroy',['ArticleCategory'=>$item->id])}}')">
                                                    <span class=""><i
