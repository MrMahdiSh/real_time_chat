...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('partials.breadcrumb',['title'=>'ویرایش پیوند'])
                                ...
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">ویرایش پیوند</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('Link.update',['Link'=>$data->id])}}"
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" id="type"
                                                            ...
                                                            <option
                                                                {{$data->type=='top' ? 'selected' : ''}} value="top">
                                                                بالای صفحه
                                                            </option>
                                                            <option
                                                                {{$data->type!='top' ? 'selected' : ''}} value="bottom">
                                                                پایین صفحه
                                                            </option>
                                                        </select>
                                                    </div>
...
@section('js')
    ...
    {!! JsValidator::formRequest('Modules\Link\Http\Requests\CreateLinkValidation', '#form'); !!}
