...
@section('content')
    ...
    @include('blog::partials.doctor_breadcrumb',['title'=>'ثبت محصول'])
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-7 col-lg-8 col-xl-9">
                    ...
                    <form method="post" class="form" name="form" id="form" action="{{route('doctor.product.post')}}"
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="offer" id="offer" type="number"
                                                   class="form-control">
                                        </div>
                                    </div>
