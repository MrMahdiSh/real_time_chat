...
@section('content')
    ...
    @include('blog::partials.doctor_breadcrumb',['title'=>'ثبت مقاله'])
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-7 col-lg-8 col-xl-9">
                    ...
                    <form method="post" name="form" id="form" action="{{route('doctor.article.post')}}"
                          enctype="multipart/form-data">
                        @csrf

                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ثبت مقاله</h4>
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="insta_link" id="insta_link" type="text" class="form-control"
                                            >
                                        </div>
                                    </div>
