...
@section('content')
    ...
    @include('blog::partials.doctor_breadcrumb',['title'=>'سفارش های من'])
                                                            ...
                                                            @isset($val->orders)
                                                                ...
                                                                @foreach($val->orders  as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td><a href=" "
                                                                               class="avatar avatar-sm me-2">
                                                                                <img class="avatar-img rounded-circle"
                                                                                     src="{{$item->patient->media  ? $item->patient->media->url : asset('assets/img/avatar.jpg')}}"
                                                                                     alt="User Image">
                                                                            </a></td>
                                                                        <td>
                                                                        ...
                                                                        <td>{{number_format($item->price,null)}}تومان
                                                                        </td>
