...
@section('content')
    ...
    @include('blog::partials.doctor_breadcrumb',['title'=>'سیستم تیکت'])
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="chat-window">
                        ...
                        @include('blog::partials.ticket_sidebar',['id'=>isset($id) ?  $id : null])
...
@section('js')
    ...
    <script>
        ...
        function side_bar_chat(search = '', client_id = null) {
            ...
            const base_url = '{{route('doctor.ticket.side_bar')}}';
        ...
        function chat_content(client_id) {
            ...
            const doc_id = '{{Auth::guard('doctor')->check() ? Auth::id() : ''}}';
            const base_url = '{{route('doctor.ticket.content')}}';
            // let url = `${base_url}`;
