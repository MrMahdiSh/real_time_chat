                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header">
                                    <h3>فرم ثبت نام پزشکان</h3>
                                </div>

                                <form action="{{route('doctor.register.post')}}" method="post" name="form" id="form">

                                    @csrf
                                    <div class="form-group form-focus">
                                        <input name="name" id="name" type="text" class="form-control floating">
                                        <label class="focus-label">نام</label>
                                    </div>
                                    <div class="form-group form-focus">
                                        <input name="family" id="family" type="text" class="form-control floating">
                                    ...
                                    <div class="form-group form-focus">
                                        <input name="password_confirmation" id="password_confirmation" type="password"
                                               class="form-control floating">
                                        <label class="focus-label">تکرار مجدد رمز عبور</label>
                                    </div>

                                    <div class="text-end">
                                        <a class="forgot-link" href="{{route('doctor.login')}}">حساب کاربری دارید ؟ از
                                            اینجا وارد
                                            شوید</a>
                                    </div>
                                    <button class="btn btn-primary w-100 btn-lg login-btn" type="submit">ثبت‌نام
                                    </button>
