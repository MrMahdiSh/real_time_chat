                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header">
                                    <h3>فرم ورود کاربران</h3>
                                </div>

                                <form action="{{route('patient.login.post')}}" method="post" name="form" id="form">
                                    ...
                                    <div class="text-end">
                                        <a class="forgot-link" href="{{route('patient.register')}}">حساب کاربری ندارید ؟
                                            از
                                            اینجا وارد
                                            شوید</a>
                                    </div>
