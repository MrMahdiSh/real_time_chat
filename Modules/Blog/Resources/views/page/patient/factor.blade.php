                    ...
                    <div class="other-info">
                        <td class="text-end">
                            <div class="table-action">
                                @if($data->status==\App\Status::Success)
                                ...
                                @if($data->status=='reserve' || $data->status=='')
                                    <a href="{{route('patient.payment.factor',['id'=>$data->id])}}"
                                       class="btn btn-sm bg-warning">
                                        <i class="far fa-money-bill-alt "></i> پرداخت
                                    </a>
                                @endif
                                @if($data->status=='reserve' || $data->status=='')
                                    <a href="{{route('patient.payment.wallet',['id'=>$data->id])}}"
                                       class="btn btn-sm bg-warning">
                        ...
                        <div class="invoice-content"
                            ...
                            <div class="invoice-item">
                                <div class="row">
                                    ...
                                    @elseif($data->status=='reserve' || $data->status=='')
                                        <div class="col-md-6">
                                            <div class="invoice-logo">
                                    ...
                                    <div class="col-md-6">
                                        <p class="invoice-logo">
                                            <strong>سفارش:</strong> #{{$data->number}} <br>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="invoice-table table table-bordered">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td class="text-center">ثبت نوبت</td>
