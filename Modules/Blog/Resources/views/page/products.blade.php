        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-12 col-12">
                    ...
                    <h2 class="breadcrumb-title">‌لیست محصولات</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 col-lg-3 col-xl-3 theiaStickySidebar">
                    ...
                    <form action="{{route('products')}}" method="get" id="form" name="form">
                                            ...
                                            <div style="text-align: right;">
                                                <label class="custom_check">
                                                    <img
                                                        ...
                                                        width="30" height="30">
                                                    <input type="checkbox"
                                                           {{ in_array($item->id, request('brands', [])) ? 'checked' : '' }} name="brands[]"
                                                           value="{{ $item->id }}">
                                                    <span class="checkmark"></span>
                                                    {{$item->title}}
                    ...
                    <div class="row">
                        ...
                        @isset($data)
                            ...
                            @foreach($data as $item)
                                @component('blog::componets.product',['item'=>$item])
                                @endcomponent
                            @endforeach
