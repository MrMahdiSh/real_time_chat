                                                        ...
                                                        @if(Carbon\Carbon::parse($weekStartDate)->addDay()  >  Carbon\Carbon::now())
                                                            <li>
                                                                ...
                                                                @for($i=$val->s_time;$i<=$val->e_time;$i++)
                                                                    ...
                                                                    @if(empty($check))
                                                                        <a class="timing"
                                                                           href="@if(Auth::guard('patient')->check())    {{route('reserved_service_doctor_schedule',['service_id'=>request('service_id'),'time'=>"$hour:$minute",'date'=>$date,'doc_id'=>$data->id])}} @else{{route('patient.login')}} @endif">
