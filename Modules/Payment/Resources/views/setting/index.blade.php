...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('partials.breadcrumb',['title'=>'تنظیمات پرداخت'])
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">تنظیمات پرداخت</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <p class="alert alert-info">مرچنت کد مورد نظر بر پایه درگاه پرداخت <a
                                                target="_blank" href="https://www.zarinpal.com/">زرین پال</a> ایجاد شده
                                            است</p>
                                        <!-- users edit media object ends -->
                                        <!-- users edit account form start -->
                                        <form id="form" name="form"
                                              action="{{route('PaymentSetting.update',['PaymentSetting'=>'1'])}}"
...
@section('js')
    ...
    {!! JsValidator::formRequest('Modules\Payment\Http\Requests\CreatePaymentSettingValidation', '#form'); !!}
