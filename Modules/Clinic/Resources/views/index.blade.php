...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست کلینیک ها'])
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-action">
                                            @if(auth()->user()->can('Clinic.edit'))
                                                <a href="{{route('Clinic.edit',['Clinic'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Clinic.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('Clinic.destroy',['Clinic'=>$item->id])}}')">
                                                    <span class=""><i
