...
@section('css')
    <Clinic rel="stylesheet" href="{{asset('assets/slim_cropper/css/style.css?v=5.3.1')}}">
        ...
        @section('content')
            ...
            <div class="app-content content">
                ...
                <div class="content-wrapper">
                    @include('partials.breadcrumb',['title'=>'ویرایش کلینیک'])
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs mb-3" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-Clinic d-flex align-items-center active" id="account-tab"
                                                   data-toggle="tab" href="#account" aria-controls="account" role="tab"
                                                   aria-selected="true">
                                                    <i class="feather icon-user mr-25"></i><span
                                                        class="d-none d-sm-block">ویرایش کلینیک</span>
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                                ...
                                                <form id="form" name="form"
                                                      action="{{route('Clinic.update',['Clinic'=>$data->id])}}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @include('partials.multi_upload_file',[                                'title'=>'آپلود فایل ها',
                                                                                                                                                                    'images'=>$data->gallery ? $data->gallery : null,
                                                                                                                                                                    'name'=>'gallery[]',
        ...
        @section('js')
            ...
            {!! JsValidator::formRequest('Modules\Clinic\Http\Requests\ClinicValidation', '#form'); !!}
