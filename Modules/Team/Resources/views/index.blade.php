...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست نفرات'])
                            ...
                            @if(isset($data))
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="product-name">{{$item->degree}}</td>

                                        <td class="product-action">
                                            @if(auth()->user()->can('Team.edit'))
                                                <a href="{{route('Team.edit',['Team'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Team.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('Team.destroy',['Team'=>$item->id])}}')">
                                                    <span class=""><i
