...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('partials.breadcrumb',['title'=>'تنظیمات'])
                                ...
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">تنظیمات</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('ServiceSetting.update',['ServiceSetting'=>$data? $data->id : 1])}}"
                                                ...
                                                <div class="col-12 col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <textarea name="rules"
                                                                      id="editor">{{$data ? $data->rules: ''}}</textarea>
...
@section('js')
    ...
    {!! JsValidator::formRequest('Modules\Service\Http\Requests\ServiceSettingValidation', '#form'); !!}
