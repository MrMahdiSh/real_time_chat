...
use App\Repositories\Service\ServiceOrderRepository;
...
class ServiceOrderController extends Controller
{
    ...
    public function __construct(ServiceOrderRepository $model)
    {
    ...
    public function index()
    {
        ...
        return view('service::orders.index', compact('data'));
    }
