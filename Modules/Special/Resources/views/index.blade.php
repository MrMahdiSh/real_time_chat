...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست ویژگی ها'])
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="product-action">
                                            ...
                                            @if(auth()->user()->can('Special.edit'))
                                                <a href="{{route('Special.edit',['Special'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif


                                            @if(auth()->user()->can('Special.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('Special.destroy',['Special'=>$item->id])}}')">
                                                    <span class=""><i
