...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست محصولات'])
                            ...
                            @if(isset($data))
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="product-name">{{number_format($item->price,null)}}</td>
                                        <td class="product-name">{{$item->count}}</td>
                                        <td class="product-name">{{$item->offer}}</td>

                                        <td class="product-action">
                                            @if(auth()->user()->can('Product.edit'))
                                                <a href="{{route('Product.edit',['Product'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Product.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('Product.destroy',['Product'=>$item->id])}}')">
                                                    <span class=""><i
