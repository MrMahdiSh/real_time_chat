...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('partials.breadcrumb',['title'=>'ویرایش داروخانه'])
                                ...
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">ویرایش داروخانه</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        <form id="form" name="form"
                                              action="{{route('Pharmacy.update',['Pharmacy'=>$data->id])}}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="city_id" id="city_id"
                                                                ...
                                                                @foreach($cities as $item)
                                                                    <option
                                                                        {{(int)$data->city_id==$item->id ? 'selected' : ''}}
