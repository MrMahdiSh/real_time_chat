...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @include('partials.breadcrumb',['title'=>'لیست برندها'])
                        ...
                        <table class="table data-list-view">
                            ...
                            @if(isset($data))
                                ...
                                @foreach($data as $key=>$item)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td class="product-img sorting_1  "><img width="100" class="rounded rounded-circle"
                                                                                                      height="100"
                                        ...
                                        <td class="product-action">
                                            @if(auth()->user()->can('Product.edit'))
                                                <a href="{{route('ProductBrand.edit',['ProductBrand'=>$item->id])}}"><span
                                                        class="action-edit"><i class="feather icon-edit"></i></span></a>
                                            @endif
                                            @if(auth()->user()->can('Product.destroy'))
                                                <a href="#"
                                                   onclick="delete_item('{{route('ProductBrand.destroy',['ProductBrand'=>$item->id])}}')">
                                                    <span class=""><i
